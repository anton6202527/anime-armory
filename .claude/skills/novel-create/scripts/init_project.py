...
# 平台无关的规模档：章数 + 每章字数区间。漫剧=抖音漫剧档（短章高频）。
SCALE_PROFILE = {
    "short":  {"target_chapters": 3,  "words_per_chapter": [6000, 10000], "demo": 1},
    "medium": {"target_chapters": 12, "words_per_chapter": [4000, 6000],  "demo": 2},
    "long":   {"target_chapters": 40, "words_per_chapter": [3000, 5000],  "demo": 3},
    "漫剧":   {"target_chapters": 80, "words_per_chapter": [1500, 2500],  "demo": 3},
}
