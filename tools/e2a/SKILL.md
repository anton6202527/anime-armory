...
anime-armory GitHub Release assets. Successor of the retired Tauri `/r2a`
...
- Default builds **both** the app and the demo zip assets (the retired Tauri
  `/r2a` defaulted to apps-only — this tool exists for the "Electron app 包括
