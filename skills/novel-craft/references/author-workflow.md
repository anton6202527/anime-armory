...
python3 skills/novel-create/scripts/init_project.py --title "<暂定名>" --genre "<题材>" --premise "<一句话故事>" --scale short
python3 skills/novel-settings/scripts/settings_cli.py "<作品根>" audit
```
...
命令：
```bash
python3 skills/novel-craft/scripts/author_intent.py scaffold "<作品根>"
python3 skills/novel-craft/scripts/author_intent.py check "<作品根>" --write
python3 skills/novel-score/scripts/collect_market_baseline.py "<作品根>/评分" --target-platform "<目标平台>" --allow-fetch-errors
python3 skills/novel-craft/scripts/author_workflow.py "<作品根>" --write
```
...
命令：
```bash
python3 skills/novel-research/scripts/research_pack.py jobs "<作品根>"
python3 skills/novel-research/scripts/research_pack.py scaffold "<作品根>" --topic "<主题>" --domain platform --source "<标题>|<日期>|official|high|<URL>|<说明>" --claim "<事实>|SRC-001|high|all|<用法>|<不确定项>|<禁用写法>"
python3 skills/novel-research/scripts/research_pack.py scene-usage "<作品根>"
python3 skills/novel-observe/scripts/observe.py scaffold "<作品根>"
python3 skills/novel-observe/scripts/observe.py select "<作品根>" --chapter NN --write-packet
...
命令：
```bash
python3 skills/novel-craft/scripts/scene_cards.py scaffold "<作品根>"
python3 skills/novel-craft/scripts/scene_cards.py check "<作品根>"
python3 skills/novel-craft/scripts/manuscript_map.py "<作品根>" --write
...
命令：
```bash
python3 skills/novel-review/scripts/consistency_audit.py "<作品根>"
python3 skills/novel-score/scripts/score.py "<作品根>" --scope opening
python3 skills/novel-craft/scripts/demo_readiness.py "<作品根>" --write
python3 skills/novel-craft/scripts/semantic_job.py claim "<作品根>/语义任务/<score_job>.json" --claimed-by reviewer
```
...
python3 skills/novel-craft/scripts/draft_packets.py "<作品根>" --chapter NN
python3 skills/novel-craft/scripts/propose_state_delta.py "<作品根>" --chapter NN
...
命令：
```bash
python3 skills/novel-craft/scripts/arc_packets.py "<作品根>" --arc AA-BB
python3 skills/novel-review/scripts/arc_gate.py "<作品根>" --arc AA-BB
python3 skills/novel-review/scripts/consistency_audit.py "<作品根>"
```
...
命令：
```bash
python3 skills/novel-score/scripts/score.py "<作品根>" --scope full
python3 skills/novel-review/scripts/build_review_report.py "<作品根>"
python3 skills/novel-simulate/scripts/simulate_panel.py "<作品根>" --scope opening
python3 skills/novel-feedback/scripts/reader_test_plan.py "<作品根>" --scope opening:1-3 --target-reader "<目标读者>" --cohort "核心读者|来源|纳入标准" --ab-test-id "opening-ab-001" --privacy-note "匿名指标与必要评论"
python3 skills/novel-feedback/scripts/ingest_reader_events.py "<作品根>" --input "<反馈.csv>" --platform "<平台>" --source-name "<批次>"
```
...
python3 skills/novel-edit/scripts/edit_plan.py "<作品根>" --line-packet NN
python3 skills/novel-edit/scripts/edit_plan.py "<作品根>" --query-task EDIT-001 --query "<需要作者裁决的问题>" --query-severity P0
python3 skills/novel-edit/scripts/edit_plan.py "<作品根>" --answer-query QUERY-001 --answer "<作者/主编裁决>" --query-status answered
python3 skills/novel-edit/scripts/edit_plan.py "<作品根>" --close-task EDIT-001 --status fixed --note "<改法与回测>"
...
命令：
```bash
python3 skills/novel-craft/scripts/ai_usage.py "<作品根>" --text-mode AI-assisted --default-chapter-mode human_revised_ai_draft --human-contribution "<人工贡献>"
python3 skills/novel-craft/scripts/compliance_profile.py "<作品根>" --write
python3 skills/novel-craft/scripts/metadata_pack.py "<作品根>" --write
python3 skills/novel/novel-gate.py "<作品根>" --stage export
python3 skills/novel-craft/scripts/export.py "<作品根>" --formats txt,docx,outline
python3 skills/novel-craft/scripts/release_manifest.py "<作品根>" --release-name v1 --release-profile platform_publish
