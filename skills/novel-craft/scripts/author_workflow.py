    ...
    steps: list[dict[str, Any]] = [
        {
            ...
            "blockers": [],
            "warnings": [],
            "command": f'python3 skills/novel-settings/scripts/settings_cli.py "{root}" audit',
        },
        {
            "key": "blueprint",
            "label": "构思蓝图与读者契约",
            ...
            "warnings": [],
            "command": f'python3 skills/novel-craft/scripts/author_intent.py scaffold "{root}"',
        },
        {
            "key": "evidence",
            "label": "资料、观察与审美准备",
            ...
            "command": f'python3 skills/novel-research/scripts/research_pack.py scene-usage "{root}"',
        },
        {
            "key": "setting_scene",
            "label": "设定圣经、场景卡与结构地图",
            ...
            "warnings": [],
            "command": f'python3 skills/novel-craft/scripts/manuscript_map.py "{root}" --write',
        },
        {
            "key": "demo",
            ...
            "command": f'python3 skills/novel-craft/scripts/demo_readiness.py "{root}" --write',
        },
        {
            "key": "draft_loop",
            "label": "分章写作与状态账本",
        ...
        },
        {
            ...
            "command": f'python3 skills/novel-craft/scripts/revision_planner.py "{root}"',
        },
        {
            ...
            "command": f'python3 skills/novel-feedback/scripts/reader_test_plan.py "{root}" --scope opening:1-3',
        },
        {
            "key": "edit",
            "label": "分层专业编辑",
            ...
            "command": f'python3 skills/novel-edit/scripts/edit_plan.py "{root}"',
        },
        {
            "key": "publish_pack",
            "label": "AI/合规与发布元数据",
            ...
            "warnings": [],
            "command": f'python3 skills/novel-craft/scripts/metadata_pack.py "{root}" --write',
        },
        {
            "key": "release",
            "label": "导出与发布版本清单",
            ...
            "command": f'python3 skills/novel-craft/scripts/release_manifest.py "{root}" --release-name v1 --release-profile platform_publish',
        },
    ]
    return steps
...
def build_workflow(root: str) -> dict[str, Any]:
    ...
    return {
        ...
        "project_root": root,
        "reference": "skills/novel-craft/references/author-workflow.md",
