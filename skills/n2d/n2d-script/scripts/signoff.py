...
Examples:
  python3 skills/n2d/n2d-script/scripts/signoff.py <作品根> p2 init 第1集
  python3 skills/n2d/n2d-script/scripts/signoff.py <作品根> p2 approve 第1集 \
      --reviewer-id user:alice --reviewer-role director --note "blocking/axis approved"
  python3 skills/n2d/n2d-script/scripts/signoff.py <作品根> p2 check 第1集 --json
