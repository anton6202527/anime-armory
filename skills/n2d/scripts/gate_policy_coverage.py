...
GROUP_COVERAGE: Dict[str, Dict[str, Any]] = {
    "compliance": {
        "implementation": ["skills/n2d-compliance/scripts/compliance.py", "skills/n2d-review/scripts/gate.py"],
        "tests": ["skills/n2d-compliance/scripts/test_compliance.py", "skills/n2d-review/scripts/test_gate.py"],
    ...
    "voice_timing": {
        "implementation": ["skills/n2d-script/validate_timings.py", "skills/n2d-voice/render_voice.py"],
        "tests": ["skills/n2d-script/test_validate_timings.py", "skills/n2d-voice/test_render_voice.py"],
        "evidence": ["合成/{ep}/配音/时长清单.json"],
    },
    "storyboard_contract": {
        "implementation": ["skills/n2d-script/validate_storyboard_contract.py", "skills/n2d-review/scripts/gate.py"],
        "tests": ["skills/n2d-review/scripts/test_gate.py"],
        "evidence": ["脚本/{ep}/storyboard.json"],
        "release_required": True,
    },
    "style_contract": {
        "implementation": ["skills/n2d/_lib/style_policy.py", "skills/n2d-review/scripts/gate.py"],
        "tests": ["skills/n2d-review/scripts/test_style_consistency.py"],
        "evidence": ["脚本/{ep}/storyboard.json", "出图/共享/visual_state_ledger.json"],
    },
    "special_templates": {
        "implementation": ["skills/n2d-script/scripts/spectacle_contract_audit.py", "skills/n2d-review/scripts/gate.py"],
    ...
    "asset_registry": {
        "implementation": ["skills/n2d-asset-market/scripts/asset_registry.py", "skills/n2d-review/scripts/gate.py"],
        "tests": ["skills/n2d-asset-market/scripts/test_asset_registry.py", "skills/n2d-review/scripts/test_gate.py"],
        "evidence": ["出图/共享/asset_registry.json"],
        "release_required": True,
    },
    "retention": {
        "implementation": ["skills/n2d-script/scripts/beat_audit.py", "skills/n2d-script/scripts/story_integrity_audit.py"],
        "tests": ["skills/n2d-script/scripts/test_story_integrity_audit.py", "skills/n2d-review/scripts/test_gate.py"],
        "evidence": ["生产数据/story_integrity_{ep}.json", "生产数据/beat_audit_{ep}.json"],
    },
    "budget": {
        "implementation": ["skills/n2d-batch/scripts/queue.py", "skills/n2d-review/scripts/gate.py"],
        "tests": ["skills/n2d-batch/scripts/test_queue.py", "skills/n2d-review/scripts/test_gate.py"],
    ...
    "backend_evidence": {
        ...
        "tests": ["skills/n2d/_lib/test_video_backend_adapter.py", "skills/n2d-review/scripts/test_gate.py"],
    ...
    "skill_freshness": {
        ...
        "implementation": ["skills/n2d/_lib/skill_freshness.py", "skills/n2d-review/scripts/gate.py"],
        "tests": ["skills/n2d/_lib/test_skill_freshness.py", "skills/n2d-review/scripts/test_gate.py"],
        "evidence": ["生产数据/skill_update_snapshot.json"],
    },
    "image_qc": {
        "implementation": ["skills/n2d-image/scripts/image_qc.py", "skills/n2d-review/scripts/gate.py"],
        "tests": ["skills/n2d-image/scripts/test_image_qc.py", "skills/n2d-review/scripts/test_gate.py"],
        "evidence": ["生产数据/image_qc/{ep}/image_qc_{ep}.json"],
        "release_required": True,
    },
    "consistency_audit": {
        "implementation": ["skills/n2d-review/scripts/consistency_audit.py", "skills/n2d-review/scripts/gate.py"],
        "tests": ["skills/n2d-review/scripts/test_consistency_audit.py", "skills/n2d-review/scripts/test_gate.py"],
        "evidence": ["生产数据/consistency_ledger_{ep}.json", "生产数据/gate_findings_*_{ep}.json"],
        "release_required": True,
    },
    "generation_recipe": {
        "implementation": ["skills/n2d/scripts/generation_recipe_manifest.py", "skills/n2d-review/scripts/gate.py"],
        "tests": ["skills/n2d/scripts/test_generation_recipe_manifest.py", "skills/n2d-review/scripts/test_gate.py"],
    ...
    "contract_inheritance": {
        "implementation": ["skills/n2d-video/scripts/inherit_contract.py", "skills/n2d-review/scripts/gate.py"],
        "tests": ["skills/n2d-video/scripts/test_inherit_contract.py", "skills/n2d-review/scripts/test_gate.py"],
        "evidence": ["生产数据/contract_inheritance_{ep}.json"],
        "release_required": True,
    },
    "identity_handoff": {
        "implementation": ["skills/n2d/_lib/n2d_handoff.py", "skills/n2d-review/scripts/gate.py"],
        "tests": ["skills/n2d-review/scripts/test_gate.py"],
    ...
    "model_router": {
        "implementation": ["skills/n2d-model-router/scripts/router.py"],
        "tests": ["skills/n2d-model-router/scripts/test_router.py"],
        "evidence": ["出视频/{ep}/prompt/video_model_routes.json"],
    },
    "motion_contract": {
        "implementation": ["skills/n2d-model-router/scripts/motion_control.py", "skills/n2d-script/scripts/spectacle_plan.py"],
        "tests": ["skills/n2d-model-router/scripts/test_motion_control.py"],
        "evidence": ["生产数据/motion_control_manifest.json", "生产数据/spectacle_plan_{ep}.json"],
    },
    "video_routes": {
        "implementation": ["skills/n2d-model-router/scripts/router.py", "skills/n2d-review/scripts/gate.py"],
        "tests": ["skills/n2d-model-router/scripts/test_router.py", "skills/n2d-review/scripts/test_gate.py"],
        "evidence": ["出视频/{ep}/prompt/video_model_routes.json"],
        "release_required": True,
    },
    "video_assets": {
        "implementation": ["skills/n2d-video/scripts/video_qc.py", "skills/n2d-review/scripts/gate.py"],
        "tests": ["skills/n2d-video/scripts/test_video_qc.py", "skills/n2d-review/scripts/test_gate.py"],
        "evidence": ["出视频/{ep}/视频/*.mp4"],
        "release_required": True,
    },
    "semantic_lineage": {
        "implementation": ["skills/n2d-review/scripts/semantic_continuity.py", "skills/n2d-review/scripts/gate.py"],
        "tests": ["skills/n2d-review/scripts/test_semantic_continuity.py", "skills/n2d-review/scripts/test_gate.py"],
        "evidence": ["脚本/{ep}/storyboard.json", "出图/{ep}/prompt/*.md", "出视频/{ep}/prompt/*.md"],
    },
    "compose_inputs": {
        "implementation": ["skills/n2d-compose/release_manifest.py", "skills/n2d-review/scripts/gate.py"],
        "tests": ["skills/n2d-compose/test_release_manifest.py", "skills/n2d-review/scripts/test_gate.py"],
        "evidence": ["合成/{ep}/成片_{ep}_*.mp4", "出视频/{ep}/视频/*.mp4"],
        "release_required": True,
    },
    "subtitle_alignment": {
        "implementation": ["skills/n2d-review/scripts/subtitle_align.py", "skills/n2d-review/scripts/gate.py"],
        "tests": ["skills/n2d-review/scripts/test_subtitle_align.py", "skills/n2d-review/scripts/test_gate.py"],
    ...
    "score": {
        ...
        "tests": ["skills/n2d-score/scripts/test_score.py"],
        "evidence": ["生产数据/score_{ep}.json"],
        "release_required": True,
    },
    "review_ui": {
        "implementation": ["skills/n2d-review-ui/scripts/review_ui.py"],
        "tests": ["skills/n2d-review-ui/scripts/test_review_ui.py"],
        "evidence": ["生产数据/review_ui_{ep}.json", "生产数据/review_ui_findings_{ep}.json"],
        "release_required": True,
    },
    "consistency_ledger": {
        "implementation": ["skills/n2d-review/scripts/consistency_ledger.py"],
        "tests": ["skills/n2d-review/scripts/test_consistency_ledger.py"],
        "evidence": ["生产数据/consistency_ledger_{ep}.json"],
        "release_required": True,
    },
    "human_review": {
        "implementation": ["skills/n2d-review-ui/scripts/review_ui.py", "skills/n2d-compose/release_manifest.py"],
        "tests": ["skills/n2d-review-ui/scripts/test_review_ui.py", "skills/n2d-compose/test_release_manifest.py"],
