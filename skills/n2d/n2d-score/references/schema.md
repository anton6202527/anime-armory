...
```bash
python3 skills/n2d/n2d-score/scripts/visual_checks.py <作品根> 第N集 --json
```
...
```bash
python3 skills/n2d/n2d-review/scripts/consistency_audit.py <作品根> 第N集 --json
python3 skills/n2d/n2d-review/scripts/mechanical_check.py <作品根> 第N集 --json
python3 skills/n2d/n2d-score/scripts/visual_checks.py <作品根> 第N集 --json
```
