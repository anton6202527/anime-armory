...
def test_suggest_without_drift_report_hints_identity_write(tmp_path, capsys):
    ...
    assert "skills/n2d/n2d-identity/scripts/identity.py" in out
        ...
        "recommendations": [
            {
                ...
                "reason": "2 集脸部相似度低于阈值",
                "next_command": "python3 skills/n2d/n2d-lora/scripts/lora.py init 'x' --character-id CHAR_SHEN --form '常态'",
            }
        ],
    }
