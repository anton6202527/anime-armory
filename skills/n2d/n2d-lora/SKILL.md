...
```bash
python3 skills/n2d/n2d-lora/scripts/lora.py suggest <作品根>   # Stage -1：读漂移报表打印升档建议
python3 skills/n2d/n2d-lora/scripts/lora.py init <作品根> --character-id CHAR_XXX --form 常态
python3 skills/n2d/n2d-lora/scripts/lora.py dataset <作品根> --character-id CHAR_XXX --form 常态 --copy-references
python3 skills/n2d/n2d-lora/scripts/lora.py train-job <作品根> --character-id CHAR_XXX --form 常态 --provider manual
python3 skills/n2d/n2d-lora/scripts/lora.py package <作品根> --character-id CHAR_XXX --form 常态 --provider manual
python3 skills/n2d/n2d-lora/scripts/lora.py validate <作品根> --character-id CHAR_XXX --form 常态 --model-path <模型.safetensors> --approved  # 数据集无 warning 时
python3 skills/n2d/n2d-lora/scripts/lora.py register <作品根> --character-id CHAR_XXX --form 常态
python3 skills/n2d/n2d-lora/scripts/lora.py exception-scope <作品根> 第N集 --character-id CHAR_XXX --form 常态 --clip Clip_03 --reason "<为什么只有这几个 hero 镜用 LoRA>" --project-image-model "<本剧主生图模型>" --lora-base-model "<LoRA底模>" --style-bridge "<如何贴回本剧风格/LUT/QC>"
...
python3 skills/n2d/n2d-lora/scripts/sdxl_local.py route <作品根> --character-id CHAR_XXX --form 常态 --write  # 同时写最近一次总账和角色/形态专属 route
python3 skills/n2d/n2d-lora/scripts/local_train.py prepare <作品根> --character-id CHAR_XXX --form 常态  # 生成 sd-scripts dataset config 和可审计命令；macOS MPS 必须把打印的 conda 命令直接从顶层 zsh 执行，不能用 run/脚本文件包装
python3 skills/n2d/n2d-lora/scripts/sdxl_local.py workflow <作品根> 第N集 --clip Clip_03 --character-id CHAR_XXX --checkpoint "<sdxl.safetensors>" --lora "<char.safetensors>" --prompt "<hero shot prompt>"
python3 skills/n2d/n2d-lora/scripts/sdxl_local.py record-output <作品根> 第N集 --clip Clip_03 --output "<输出PNG路径>" --lora-model "<char.safetensors>"
```
...
```bash
python3 skills/n2d/n2d-lora/scripts/lora.py suggest <作品根>
```
...
`python3 skills/n2d/n2d-identity/scripts/identity.py <作品根> --write`；报表 `available=false`（机检缺依赖）
...
```bash
python3 skills/n2d/n2d-lora/scripts/sdxl_local.py route <作品根> --character-id CHAR_XXX --form 常态 --write
```
