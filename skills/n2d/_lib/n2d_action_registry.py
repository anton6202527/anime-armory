...
STAGE_ACTIONS: Dict[str, Dict[str, Any]] = {
    ...
    "script_stage2": _base(
        ...
        prework=["source_check", "update_plan", "doctor", "director_blocking_pack"],
    ),
    "image_prompt": _base(
        "image_prompt",
        "n2d-image",
    ...
    "image": _base(
        ...
        specialist="n2d-visual-agent",
        stop="needs_payment_confirm",
        prework=["doctor", "production_breakdown", "identity", "reference_plan", "image_preflight_gate", "compliance"],
    ),
    "video_prompt": _base(
        "video_prompt",
        "n2d-video",
