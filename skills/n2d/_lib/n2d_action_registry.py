...
STAGE_ACTIONS: Dict[str, Dict[str, Any]] = {
    "script_stage1": _base(
        ...
        prework=["source_check", "update_plan", "doctor", "midstart_context", "boundary_audit"],
    ),
    "voice": _base(
        "voice",
        "n2d-voice",
    ...
    "script_stage2": _base(
        ...
        prework=["source_check", "update_plan", "doctor"],
    ),
    "image_prompt": _base(
        "image_prompt",
        "n2d-image",
    ...
    "image": _base(
        ...
        specialist="n2d-visual-agent",
        stop="needs_payment_confirm",
        prework=["doctor", "identity", "reference_plan", "image_preflight_gate", "compliance"],
    ),
    "video_prompt": _base(
        "video_prompt",
        "n2d-video",
    ...
    "video": _base(
        ...
        specialist="n2d-visual-agent",
        stop="needs_payment_confirm",
        prework=["model_router", "shared_video_materialize", "identity", "image_qc", "video_preflight_gate", "compliance"],
    ),
    "compose": _base(
        "compose",
        "n2d-compose",
        ...
        stop="needs_payment_confirm",
        prework=["mouth_visible_audit", "shared_video_materialize", "action_edit_cues", "identity", "image_qc", "compose_gate", "compliance"],
    ),
    "review": _base(
        "review",
        "n2d-review",
