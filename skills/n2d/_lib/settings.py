...
DEFAULTS = {
    ...
    "视频备用后端": "",
    "中段锚帧默认": "关闭",
    # 非人物特写覆盖：新项目默认「启用」（系统面板缺 insert→block、道具→warn）。老项目 _设置.md 无此键时
    # 读侧走 n2d_insert_coverage 宽限默认「仅提示」，绝不追溯 block；DEFAULTS 只影响新项目 init 预填。
    "非人物特写覆盖": "启用",
    "重抽预算策略": "预算充足",
    "出视频规格": "预算充足",
    "视频分辨率": "720p",
...
SETTING_SPECS: Tuple[SettingSpec, ...] = (
    ...
    SettingSpec("生图AI", ("n2d",), (
        "Codex", "OpenAI", "Dreamina/即梦官方 CLI", "即梦", "dreamina",
        "Seedream", "可灵主体库", "Nano Banana", "Sora Cameo", "自定义官方后端", "自定义",
    ), key_aliases=("生图渠道", "生图入口"), parameterized=True),
    ...
    # 非人物特写覆盖：治「时时刻刻都给人镜头」。启用=系统面板缺专属 insert→block、道具→warn；仅提示=全 warn；
    # 关闭=静默。缺省（老项目未写）读侧按「仅提示」宽限，不追溯 block。真值口径在 n2d_insert_coverage。
    SettingSpec("非人物特写覆盖", ("n2d",), ("启用", "仅提示", "关闭"),
                aliases={"开启": "启用", "强制": "启用", "硬闸": "启用", "enforce": "启用",
                         "提示": "仅提示", "仅警告": "仅提示", "advisory": "仅提示", "warn": "仅提示",
                         "禁用": "关闭", "不检": "关闭", "off": "关闭"}),
    SettingSpec(
        "一致性增强",
        ("n2d",),
