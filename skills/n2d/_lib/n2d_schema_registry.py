...
NOVEL_HANDOFF_KIND = "novel_review_to_n2d_handoff"
NOVEL_EPISODE_SCOPE_KIND = "novel_review_episode_scope"
...
SCHEMAS: Dict[str, Dict[str, Any]] = {
    ...
    NOVEL_HANDOFF_KIND: obj(
        ("kind", "version", "status", "novel_project", "n2d_project", "decision", "files"),
        {
            "kind": {"type": "string", "enum": [NOVEL_HANDOFF_KIND]},
            "version": {"type": "integer"},
            "created_at": {"type": "string"},
            "status": {"type": "string"},
            "novel_project": {"type": "string"},
            "n2d_project": {"type": "string"},
            "decision": {"type": "object"},
            "files": arr(obj(("role", "path", "sha256"), {
                "role": {"type": "string"},
                "path": {"type": "string"},
                "sha256": {"type": "string"},
            })),
            "gates": {"type": "object"},
            "skill_notes": arr({"type": "string"}),
        },
    ),
    NOVEL_EPISODE_SCOPE_KIND: obj(
        ("kind", "version", "title", "episode_count", "episodes"),
        {
            "kind": {"type": "string", "enum": [NOVEL_EPISODE_SCOPE_KIND]},
            "version": {"type": "integer"},
            "title": {"type": "string"},
            "source": {"type": "object"},
            "episode_count": {"type": "integer"},
            "rule": {"type": "string"},
            "episodes": arr(obj(("episode", "source_chapters", "node", "cliffhanger"), {
                "episode": {"type": "string"},
