...
```bash
python3 skills/n2d/n2d-feedback/scripts/feedback.py 创作区/制漫剧/<剧名> --extract-features-only --write-features
python3 skills/n2d/n2d-feedback/scripts/feedback.py 创作区/制漫剧/<剧名> --metrics 创作区/制漫剧/<剧名>/生产数据/platform_metrics.csv --write-features
```
