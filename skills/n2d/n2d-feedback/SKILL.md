...
```bash
python3 skills/n2d/n2d-feedback/scripts/feedback.py <作品根> \
  --metrics <平台指标.csv>
```
...
```bash
python3 skills/n2d/n2d-feedback/scripts/experiments.py upsert <作品根> \
  --id EP01_launch \
  --episode 第1集 \
...
python3 skills/n2d/n2d-feedback/scripts/experiments.py audit <作品根> \
...
```bash
python3 skills/n2d/n2d-feedback/scripts/feedback.py <作品根> --extract-features-only --write-features
python3 skills/n2d/n2d-feedback/scripts/feedback.py <作品根> --metrics <平台指标.csv> --write-features
```
