...
cd skills/n2d/n2d-review/scripts && python -m pytest test_consistency_audit.py
"""
...
# 运行：cd skills/n2d/n2d-review/scripts && python -m pytest test_consistency_audit.py -k evidence_grade
# ───────────────────────────────────────────────────────────────────────────
...
# 运行：cd skills/n2d/n2d-review/scripts && python -m pytest test_consistency_audit.py -k scene_drift
# ───────────────────────────────────────────────────────────────────────────
