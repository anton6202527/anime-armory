...
cd skills/n2d/n2d-review/scripts && python3 -m pytest test_dof_consistency.py
"""
...
# 运行：cd skills/n2d/n2d-review/scripts && python -m pytest test_dof_consistency.py -k dof_profile
