...
cd skills/n2d/n2d-review/scripts && python -m pytest test_scene_consistency.py
"""
...
# 运行：cd skills/n2d/n2d-review/scripts && python -m pytest test_scene_consistency.py -k lighting
