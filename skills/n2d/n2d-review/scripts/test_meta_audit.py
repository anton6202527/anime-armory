...
REPO_ROOT = SCRIPT.resolve().parents[4]
...
def _vulnerable_repo(root: Path) -> None:
    ...
    _write(root, "skills/n2d/n2d-review/SKILL.md", "多视角身份包(MVIEW)：失败行阻断\n")
    _write(root, "skills/n2d/n2d-image/SKILL.md", "对齐不达标 = 与脸漂同级硬伤、不得落档。\n")
    _write(
        root,
    ...
    _write(root, "skills/n2d/n2d-review/scripts/gate.py", "check_identity_registry(root)\n")
    _write(
        root,
    ...
    _write(root, "skills/n2d/n2d-review/scripts/test_gate.py", "def test_smoke(): pass\n")
    _write(
        root,
    ...
    _write(root, "skills/n2d/n2d-script/scripts/test_boundary_review.py", "def test_signed(): pass\n")
                ...
                "evidence": [
                    {
                        ...
                        "implementation_mapping": [
                            {
                                "path": "skills/n2d/n2d-review/scripts/production_consistency.py",
