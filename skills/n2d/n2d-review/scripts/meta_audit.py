...
BUILTIN_CLAIMS: List[Dict[str, Any]] = [
    {
        ...
        "links": {
            ...
            "implementation": [_req(
                "skills/n2d/n2d-review/scripts/gate_core.py",
    ...
    },
    {
        ...
        "links": {
            "declaration": [_req(
                "skills/n2d/n2d-review/SKILL.md",
                r"多视角身份包\(MVIEW\)[^\n]*(?:失败行|失败桶)[^\n]*阻断",
            )],
            "implementation": [_req(
                "skills/n2d/n2d-review/scripts/production_consistency.py",
                r"failed_buckets",
            ...
            "test": [_req(
                "skills/n2d/n2d-review/scripts/test_production_consistency.py",
                r"def test_[^\n]*multiview",
            )],
            "counterexample": [_req(
                "skills/n2d/n2d-review/scripts/test_production_consistency.py",
    ...
    },
    {
        ...
        "links": {
            ...
            "implementation": [_req(
                "skills/n2d/n2d-image/scripts/image_qc.py",
            ...
            "test": [_req(
                "skills/n2d/n2d-image/scripts/test_image_qc.py",
    ...
    },
    {
        ...
        "links": {
            "declaration": [_req(
                "skills/n2d/n2d-script/SKILL.md",
                r"boundary_review\.py check[^\n]*(?:指纹|签收)",
                r"实际取材优先级[^\n]*boundary_review",
            )],
            "implementation": [_req(
                "skills/n2d/n2d-script/scripts/boundary_review.py",
            ...
            "test": [_req(
                "skills/n2d/n2d-script/scripts/test_boundary_review.py",
                r"def test_",
            )],
            "counterexample": [_req(
                "skills/n2d/n2d-script/scripts/test_boundary_review.py",
    ...
    },
    {
        ...
        "links": {
            ...
            "implementation": [
                _req(
                    "skills/n2d/n2d-review/scripts/identity_eval_pack.py",
            ...
            "invocation": [
                _req(
                    "skills/n2d/n2d-review/scripts/gates/face.py",
            ...
            "test": [_req(
                "skills/n2d/n2d-review/scripts/test_identity_eval_pack.py",
    ...
    },
    {
        ...
        "links": {
            "declaration": [_req(
                "skills/n2d/n2d-identity/SKILL.md",
                r"load-bearing[\s\S]{0,500}逐角色/形态[\s\S]{0,500}聚合",
            )],
            "implementation": [_req(
                "skills/n2d/n2d-review/scripts/gates/contract.py",
    ...
    },
    {
        ...
        "links": {
            ...
            "implementation": [_req(
                "skills/n2d/n2d-review/scripts/meta_audit.py",
            ...
            "invocation": [_req(
                "skills/n2d/n2d-review/scripts/self_audit.py",
                r"def check_meta_audit",
                r"run_tests=run_meta_tests",
                mode="all",
            )],
            "test": [_req(
                "skills/n2d/n2d-review/scripts/test_meta_audit.py",
    ...
    },
    {
        ...
        "links": {
            ...
            "implementation": [
                _req(
                    "skills/n2d/n2d-script/scripts/split_novel.py",
                ...
                _req(
                    "skills/n2d/n2d-script/scripts/boundary_audit.py",
            ...
            "test": [
                _req(
                    "skills/n2d/n2d-script/scripts/test_split_novel.py",
                ...
                _req(
                    "skills/n2d/n2d-script/scripts/test_boundary_audit.py",
...
BUILTIN_PROBES: List[Dict[str, Any]] = [
    {
        ...
        "runtime_tests": [
            "skills/n2d/n2d-review/scripts/test_gate.py::test_identity_registry_core_cannot_self_report_named_minimal",
            "skills/n2d/n2d-review/scripts/test_gate.py::test_identity_registry_tier_must_match_character_bundle_manifest_and_atlas",
        ],
    },
    {
        ...
        "runtime_tests": [
            "skills/n2d/n2d-review/scripts/test_gate.py::test_identity_registry_four_way_collusive_downgrade_blocked_by_storyboards",
            "skills/n2d/n2d-review/scripts/test_gate.py::test_storyboard_floor_rejects_collusive_restricted_partial_without_contract",
            "skills/n2d/n2d-review/scripts/test_gate.py::test_storyboard_tier_evidence_uses_structured_visible_ids_only",
            "skills/n2d/n2d-review/scripts/test_gate.py::test_identity_registry_legacy_without_structured_story_index_keeps_named_minimal",
            "skills/n2d/n2d-review/scripts/test_production_consistency.py::test_multiview_promotes_named_minimal_seen_in_ten_structured_storyboards",
            "skills/n2d/n2d-review/scripts/test_production_consistency.py::test_multiview_does_not_count_offscreen_or_forbidden_storyboard_mentions",
        ],
    },
    {
        ...
        "runtime_tests": [
            "skills/n2d/n2d-review/scripts/test_production_consistency.py::test_multiview_bucket_fail_blocks_when_top_level_verdict_missing",
        ],
    },
    {
        ...
        "runtime_tests": [
            "skills/n2d/n2d-image/scripts/test_image_qc.py::test_core_turnaround_requires_hash_bound_per_view_receipts",
        ],
    },
    {
        ...
        "runtime_tests": [
            "skills/n2d/n2d-script/scripts/test_boundary_review.py::test_move_boundary_signed_but_not_applied_fails",
        ],
    },
    {
        ...
        "runtime_tests": [
            "skills/n2d/n2d-script/scripts/test_boundary_review.py::test_mutating_decision_passes_only_after_new_sha_and_mapping_receipt",
        ],
    },
    {
        ...
        "runtime_tests": [
            "skills/n2d/n2d-review/scripts/test_gate.py::test_identity_registry_planned_makeup_reference_is_blocked",
        ],
    },
    {
        ...
        "runtime_tests": [
            "skills/n2d/n2d-review/scripts/test_identity_eval_pack.py::test_planned_view_cannot_reuse_a_stale_accepted_receipt",
        ],
    },
    {
        ...
        "runtime_tests": [
            "skills/n2d/n2d-review/scripts/test_identity_eval_pack.py::test_plain_text_with_matching_hash_cannot_pose_as_png_evidence",
        ],
    },
    {
        "id": "forged_png_shell",
        ...
        "claim_id": "multiview_evidence_freshness_binding",
        "guard": [_req(
            "skills/n2d/n2d-review/scripts/image_evidence.py",
            r"png_iend_invalid",
        ...
        "runtime_tests": [
            "skills/n2d/n2d-review/scripts/test_identity_eval_pack.py::test_forged_png_header_shell_with_matching_hash_cannot_pose_as_pixels",
        ],
    },
    {
        ...
        "runtime_tests": [
            "skills/n2d/n2d-review/scripts/test_identity_eval_pack.py::test_consumer_independently_rejects_forged_human_metadata",
        ],
    },
    {
        ...
        "runtime_tests": [
            "skills/n2d/n2d-review/scripts/test_identity_eval_pack.py::test_same_png_cannot_be_relabelled_as_multiple_views",
        ],
    },
    {
        ...
        "runtime_tests": [
            "skills/n2d/n2d-review/scripts/test_identity_eval_pack.py::test_producer_duplicate_png_sha_copy_cannot_pose_as_independent_view",
            "skills/n2d/n2d-review/scripts/test_identity_eval_pack.py::test_producer_symlink_alias_uses_canonical_realpath_and_is_blocked",
            "skills/n2d/n2d-review/scripts/test_identity_eval_pack.py::test_consumer_duplicate_png_sha_copy_is_independently_blocked",
            "skills/n2d/n2d-review/scripts/test_identity_eval_pack.py::test_consumer_symlink_alias_is_independently_blocked",
            "skills/n2d/n2d-review/scripts/test_identity_eval_pack.py::test_distinct_crop_pixels_from_same_master_remain_valid",
        ],
    },
    {
        ...
        "regression": [
            _req(
                "skills/n2d/n2d-review/scripts/test_image_evidence.py",
        ...
        "runtime_tests": [
            "skills/n2d/n2d-review/scripts/test_image_evidence.py::test_decoded_pixel_fingerprint_ignores_compression_filter_and_metadata",
            "skills/n2d/n2d-review/scripts/test_image_evidence.py::test_adam7_and_noninterlaced_encodings_share_pixel_fingerprint",
            "skills/n2d/n2d-review/scripts/test_identity_eval_pack.py::test_producer_reencoded_same_pixels_are_blocked_by_decoded_fingerprint",
            "skills/n2d/n2d-review/scripts/test_identity_eval_pack.py::test_consumer_reencoded_same_pixels_are_independently_blocked",
        ],
    },
    {
        ...
        "runtime_tests": [
            "skills/n2d/n2d-review/scripts/test_identity_eval_pack.py::test_producer_path_escape_and_absolute_registry_evidence_are_rejected",
            "skills/n2d/n2d-review/scripts/test_identity_eval_pack.py::test_consumer_path_escape_and_absolute_registry_path_are_independently_blocked",
        ],
    },
    {
        ...
        "runtime_tests": [
            "skills/n2d/n2d-image/scripts/test_image_qc.py::test_legacy_signer_path_escape_symlink_and_noncanonical_are_rejected",
            "skills/n2d/n2d-image/scripts/test_image_qc.py::test_legacy_finalize_consumer_duplicate_png_sha_is_independently_blocked",
            "skills/n2d/n2d-image/scripts/test_codex_image_runner.py::test_shared_first_pre_spend_duplicate_png_sha_blocks_copied_views",
            "skills/n2d/n2d-image/scripts/test_codex_image_runner.py::test_shared_first_pre_spend_path_escape_symlink_and_noncanonical_are_blocked",
        ],
    },
    {
        ...
        "runtime_tests": [
            "skills/n2d/n2d-review/scripts/test_identity_eval_pack.py::test_one_form_row_cannot_be_reused_for_another_form",
        ],
    },
    {
        ...
        "runtime_tests": [
            "skills/n2d/n2d-review/scripts/test_gate.py::test_memory_anchor_gate_recomputes_each_required_character_not_aggregate_count",
        ],
    },
    {
    ...
    },
    {
        ...
        "claim_id": "report_only_cache_artifact_liveness",
        "guard": [_req(
            "skills/n2d/n2d-identity/scripts/memory_anchor.py",
            r"status[\"']?\s*:\s*[\"']warn[\"']",
        ...
        "regression": [_req(
            "skills/n2d/n2d-identity/scripts/test_memory_anchor.py",
        ...
        "runtime_tests": [
            "skills/n2d/n2d-identity/scripts/test_memory_anchor.py::test_cli_overwrites_stale_ready_plan_with_explicit_unavailable_plan",
        ],
    },
    {
        ...
        "runtime_tests": [
            "skills/n2d/n2d-review/scripts/test_meta_audit.py::test_run_tests_is_the_only_path_to_adversarially_tested_and_binds_current_sha",
        ],
    },
    {
        ...
        "regression": [
            ...
            _req(
                "skills/n2d/n2d-review/scripts/test_self_audit.py",
                r"def test_cli_out_matches_json_stdout_and_preserves_block_exit",
            ),
        ],
        "runtime_tests": [
            "skills/n2d/n2d-review/scripts/test_meta_audit.py::test_cli_out_matches_json_stdout_and_governance_findings_still_exit_zero",
            "skills/n2d/n2d-review/scripts/test_self_audit.py::test_cli_out_matches_json_stdout_and_preserves_block_exit",
        ],
    },
    {
        ...
        "runtime_tests": [
            "skills/n2d/n2d-review/scripts/test_meta_audit.py::test_official_mapping_is_grounding_but_never_link_only_calibration",
        ],
    },
    {
        ...
        "runtime_tests": [
            "skills/n2d/n2d-script/scripts/test_split_novel.py::test_split_plan_v2_keeps_full_source_units_when_only_first_episode_materialized",
            "skills/n2d/n2d-script/scripts/test_split_novel.py::test_split_plan_v3_compacts_source_axis_and_rehydrates_legacy_units",
            "skills/n2d/n2d-script/scripts/test_boundary_audit.py::test_weak_next_opening_alone_enters_strict_gate",
        ],
    },
]
