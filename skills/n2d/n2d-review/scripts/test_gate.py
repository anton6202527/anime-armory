...
def test_skill_freshness_blocks_on_material_drift_before_spend():
    ...
    with tempfile.TemporaryDirectory() as td:
        _write_skill_baseline(td, sf, mutate="skills/n2d/n2d-image/SKILL.md")
        gate.findings.clear()
    ...
    with tempfile.TemporaryDirectory() as td:
        _write_skill_baseline(td, sf, mutate="skills/n2d/n2d-image/scripts/image_qc.py")
        gate.findings.clear()
        gate.check_skill_freshness(td, "第1集", "image_preflight")
        hit = [f for f in gate.findings if f["dim"] == "物料新鲜度"]
...
# 运行：cd skills/n2d/n2d-review/scripts && python -m pytest test_gate.py -k referenced_markers
# ───────────────────────────────────────────────────────────────────────────
...
# 运行：cd skills/n2d/n2d-review/scripts && python -m pytest test_gate.py -k content_fingerprint
# ───────────────────────────────────────────────────────────────────────────
...
# 运行：cd skills/n2d/n2d-review/scripts && python -m pytest test_gate.py -k evidence_grade
# ───────────────────────────────────────────────────────────────────────────
...
# 运行：cd skills/n2d/n2d-review/scripts && python -m pytest test_gate.py -k waiver_rollup
# ───────────────────────────────────────────────────────────────────────────
