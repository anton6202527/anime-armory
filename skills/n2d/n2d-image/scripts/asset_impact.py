...
def build_rerun_plan(root, keys, hits):
    ...
    if rerun:
        ...
        steps.append({
            ...
            "command": f"python3 skills/n2d/n2d-identity/scripts/identity.py {root} --write",
        ...
        for ep in episodes:
            ...
            cmd = [f"python3 skills/n2d/n2d-batch/scripts/queue.py plan {root}",
...
def main(argv):
    ...
    if batch_out:
        ...
        print(f"[batch-tasks] 对接：python3 skills/n2d/n2d-batch/scripts/queue.py plan {root} --from-asset-impact {batch_out}")
