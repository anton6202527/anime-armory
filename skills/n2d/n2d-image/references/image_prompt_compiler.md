...
```bash
python3 skills/n2d/n2d-image/scripts/image_prompt_metrics.py register <作品根> EXP_image_compact \
...
```bash
python3 skills/n2d/n2d-image/scripts/image_prompt_metrics.py report <作品根> --write
```
