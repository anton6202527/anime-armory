...
#
# Required:
#   bash skills/n2d/n2d-batch/scripts/run_n2d_video.sh <work-root> <episode>
#
...
python3 "$REPO_DIR/skills/n2d/n2d-dashboard/scripts/dashboard.py" gate "$ROOT" "$EP" --stage video_preflight
