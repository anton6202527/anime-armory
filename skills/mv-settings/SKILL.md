...
```bash
python3 skills/mv-settings/scripts/settings_cli.py audit <作品根>
python3 skills/mv-settings/scripts/settings_cli.py set <作品根> <选择点> <值>
python3 skills/mv-settings/scripts/settings_cli.py reset <作品根> <选择点>
python3 skills/mv-settings/scripts/settings_cli.py sync-global <作品根> --all
```
