...
2. **实时深搜并落证据**
   ...
   - 每条来源记录标题、URL/出处、发布日期或版本日期、访问日期、来源类型、可信度。
...
3. **生成/更新资料包**
   ...
   python3 skills/novel-research/scripts/research_pack.py scaffold "<作品根>" \
     ...
     --source "<标题>|<日期>|official|high|<URL>|<说明>" \
...
- `sources[]`: `id/title/url/source_type/published_date/accessed_date/reliability/notes`
