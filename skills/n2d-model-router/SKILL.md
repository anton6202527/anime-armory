...
- `**动作编排契约 / Action Choreography**`：打斗/追逐/飞行必填，普通镜写“无”；写 beats、speed_curve、spatial_path、camera_path、readability_beats、degrade_plan 和模板专属字段。
