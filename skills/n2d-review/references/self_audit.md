...
python3 skills/n2d-review/scripts/meta_audit.py --json
# 要声称 adversarially-tested，必须实际运行：
python3 skills/n2d-review/scripts/meta_audit.py --run-tests --json
...
```bash
python3 skills/n2d-review/scripts/meta_audit.py --print-evidence-schema
```
...
```bash
python3 skills/n2d-review/scripts/meta_audit.py --evidence <evidence.json> --json
# 或随总自审：
python3 skills/n2d-review/scripts/self_audit.py --evidence <evidence.json> --json
```
