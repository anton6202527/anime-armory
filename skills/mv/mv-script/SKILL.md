...
```bash
python3 skills/mv/mv-script/scripts/write_script.py "<制MV作品根>"
python3 skills/mv/mv-script/scripts/write_script.py "<制MV作品根>" --save
python3 skills/mv/mv-script/scripts/write_script.py "<制MV作品根>" --content-file /path/to/generated_blueprint.md
```
