...
_AD_LIB = _HERE.resolve().parents[2] / "ad" / "_lib"
...
def build_manifest(root: Path, model: str, channel: str, registry: Mapping[str, Any],
    ...
    return {
        ...
        "job": job,
        "backfill": {
            "helper": "skills/ad-craft/scripts/meta_card.py",
            "command": f'python3 skills/ad-craft/scripts/meta_card.py cover "<作品根>" --png {COVER_PNG_REL.as_posix()}',
