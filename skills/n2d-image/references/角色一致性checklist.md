...
- [ ] 每个角色/形态都有 `character_dna`：`face / hair / outfit / accessories` 五层都非空（无配饰写 `无`），并与角色卡一致
...
☐ 关键非脸资产语义复核？→ 场景/道具/独立服装/VFX 已登记且进入 scene/multimodal QC 时，full QC 环境需跑 DINO/CLIP-I 语义漂移；缺嵌入后端会 block，需补环境重跑或登记逐项人审确认
