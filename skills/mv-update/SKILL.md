...
```bash
python3 skills/mv-update/scripts/update_plan.py check "<MV项目根>" --write-plan
python3 skills/mv-update/scripts/update_plan.py record "<MV项目根>"
python3 skills/mv-update/scripts/update_plan.py check "<MV项目根>" --json
```
