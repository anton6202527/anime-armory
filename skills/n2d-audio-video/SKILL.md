...
```bash
python3 skills/n2d-audio-video/scripts/audio_video.py init \
  --audio track.wav --output track.audio-video.json

python3 skills/n2d-audio-video/scripts/audio_video.py prepare \
  track.audio-video.json --write

python3 skills/n2d-audio-video/scripts/audio_video.py validate \
