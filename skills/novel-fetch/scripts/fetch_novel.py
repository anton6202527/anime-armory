...
选项:
    --name 书名      输出文件名与标题（必填）
    --out  作品根    输出到 <作品根>/小说/；缺省 = 创作区/写小说/<书名>/
...
def main():
    ...
    ap.add_argument("--out", default=None, help="作品根；缺省 = 创作区/写小说/<书名>/")
