...
### 后端编译提交 prompt
**编译元数据**：kind=mv_compiled_video_prompt; version=1; profile_version=...; profile=...; backend=...; mode=...; language=...; native_audio_policy=external_song_track; source_contract_sha256=...
```text
