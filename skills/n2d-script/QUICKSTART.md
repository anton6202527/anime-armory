...
Command:
```bash
python3 skills/n2d-script/scripts/split_novel.py "<小说路径>" --by-chapter
# 默认首批 10 集；续切用 --limit N，全篇粗切用 --all
python3 skills/n2d-script/scripts/split_novel.py "<小说路径>" --by-chapter --limit 30
python3 skills/n2d-script/scripts/split_novel.py "<小说路径>" --by-chapter --all
# 中段开工：先补 `设定库/中段开工前情资产包.md`；用户只给模糊剧情点时，先读章节/关键词定位章号再传参
python3 skills/n2d-script/scripts/split_novel.py "<小说路径>" --by-chapter --start-chapter 48 --limit 10
