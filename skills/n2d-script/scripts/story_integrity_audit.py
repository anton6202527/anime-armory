...
GOAL_RE = re.compile(
    r"(为了|想要|我要|我得|要去|必须|誓要|不能让|守住|查清|找到|夺回|保护|救出|证明|复仇|报仇|"
    r"活下去|逃出去|赢|成亲|退婚|升级|突破|隐瞒|揭穿)"
)
FEAR_RE = re.compile(r"(害怕|担心|恐惧|怕|不敢|不能暴露|一旦.*就|否则|来不及|会死|会输|会失去)")
LEVERAGE_RE = re.compile(r"(证据|令牌|玉佩|法宝|把柄|筹码|钥匙|线索|系统|面板|名单|账册|密信|顶罪)")
...
PRESSURE_RE = re.compile(r"(威胁|逼|跪|交出|否则|休想|命令|敢|杀了|抓住|围住|质问|审问|站直|说错一句|滚出|赶出|顶罪|拿你)")
...
EVIDENCE_RE = re.compile(
    r"(查清|查案|盘问|问[鞋话]|画押|证据|物证|线索|脚印|鞋|血|血迹|茶面|账册|供词|尸身|验尸|揭穿)"
)
