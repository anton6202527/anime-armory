...
**翻译语言是投放选择，不写死**：按 `../_偏好约定.md` 的 `字幕语言` 选择点决定——默认 **中文**（国内投放，只产 `字幕_中文.srt`）；**中英双语 / 仅英文**（海外投放：TikTok / ReelShort / YouTube / 北美短剧）时再产 `字幕_英文.srt`，**两文件同一套时间码**。

标准 **SRT** 格式，可直接导入剪辑软件 / 上传平台。下面英文一节**仅在选了中英双语 / 仅英文时**适用。
