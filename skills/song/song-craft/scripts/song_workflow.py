    ...
    return [
        {
            ...
            "blockers": [],
            "warnings": [],
            "command": f'python3 skills/song/song-settings/scripts/settings_cli.py "{root}" audit',
        },
        {
            "key": "brief",
            "label": "A&R 简报与参考边界",
            ...
            "blockers": [],
            "warnings": [],
            "command": f'python3 skills/song/song-craft/scripts/song_brief.py "{root}" --write && python3 skills/song/song-craft/scripts/reference_pack.py "{root}" --write',
        },
        {
            "key": "lyrics",
            "label": "歌词、Hook 与可唱性",
            ...
            "warnings": [],
            "command": f'python3 skills/song/song-craft/scripts/lyric_prosody_check.py "{root}" --write',
        },
        {
            "key": "song_form",
            "label": "旋律/和声/曲式草图",
            ...
            "blockers": [],
            "warnings": [],
            "command": f'python3 skills/song/song-craft/scripts/melody_chord_packet.py "{root}" --write',
        },
        {
            "key": "compose_plan",
            "label": "作曲任务包",
            ...
            "blockers": [],
            "warnings": [],
            "command": f'python3 skills/song/song-compose/scripts/compose_song.py "{root}"',
        },
        {
            "key": "takes",
            "label": "多版生成与登记",
            ...
            "command": f'python3 skills/song/song-compose/scripts/compose_song.py "{root}" --register "<音频文件>" --take 1',
        },
        {
            "key": "revision",
            "label": "timecode 局部返修",
            ...
            "warnings": [],
            "command": f'python3 skills/song/song-compose/scripts/revision_plan.py "{root}" --write',
        },
        {
            "key": "selection",
            "label": "试听挑版与定稿",
            ...
            "command": f'python3 skills/song/song-compose/scripts/take_review.py "{root}" --write',
        },
        {
            "key": "mix_signoff",
            "label": "表演/混音人工签核",
            ...
            "warnings": [],
            "command": f'python3 skills/song/song-review/scripts/mix_signoff.py "{root}" --reviewer "<签核人>" --check "<NAME>|pass|<note>" --write',
        },
        {
            "key": "master_delivery",
            "label": "交付母版格式归一",
            ...
            "blockers": [],
            "warnings": [],
            "command": f'python3 skills/song/song-craft/scripts/master_delivery.py "{root}"',
        },
        {
            "key": "master_qc",
            "label": "混音/母带检查",
            ...
            "warnings": [],
            "command": f'python3 skills/song/song-review/scripts/master_check.py "{root}" --write',
        },
        {
            "key": "rights",
            ...
            "warnings": [],
            "command": f'python3 skills/song/song-craft/scripts/rights_metadata.py "{root}" --write',
        },
        {
            ...
            "warnings": [],
            "command": f'python3 skills/song/song-craft/scripts/release_metadata.py "{root}" --write',
        },
        {
            "key": "release_pack",
            "label": "发布交付包与唯一完成裁决",
        ...
        },
        {
            ...
            "command": f'python3 skills/song/song-feedback/scripts/feedback_ingest.py "{root}" --input "<反馈.csv或.jsonl>"',
        },
    ]
