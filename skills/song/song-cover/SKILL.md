...
本 skill 的可选项**不写死在源码里**。按 `../skills/song/song-craft/references/选择点与偏好.md` 读项目值、全局默认；仍缺失的普通、可逆项采用本线推荐值写回并继续。目标真人音色和原曲权利没有当前有效证据时必须停；已有合法授权不替代当前音频听审、最终成品验收或不可逆发布确认。
