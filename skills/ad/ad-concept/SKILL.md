...
按 `../skills/ad/ad-craft/references/选择点与偏好.md` 读 `<作品根>/_设置.md`。涉及：`广告类型`、`广告目标`、`漏斗阶段`、`创意路线`、`基础视觉风格`、`主片时长`、`目标平台`。
...
```bash
python3 skills/ad/ad-concept/scripts/concept_pack.py "<作品根>" --write
```
