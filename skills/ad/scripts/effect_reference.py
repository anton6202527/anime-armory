#!/usr/bin/env python3
"""Query this line's signature-effect (特效镜头) prompt library.
...
Consumers (all within this same line):
- _lib/signature_effects.py (SIGNATURE_EFFECT_LEXICON + detection helpers)
- the line's video prompt pack signature-effect injection
"""
