...
```bash
python3 skills/ad/ad-progress/scan.py                    # 扫描 创作区/拍广告/ 下所有广告项目
python3 skills/ad/ad-progress/scan.py <广告项目根>          # 只看指定广告
python3 skills/ad/ad-progress/scan.py --root <仓库根>      # 从其它目录调用时指定仓库根
```
