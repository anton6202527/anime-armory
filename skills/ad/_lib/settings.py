...
The user-facing convention lives in `skills/ad/ad-craft/references/选择点与偏好.md`. This module only
...
class SettingSpec:
    ...
    The prose source of truth remains `skills/ad/ad-craft/references/选择点与偏好.md`; this compact schema
...
SETTING_SPECS: Tuple[SettingSpec, ...] = (
    ...
    SettingSpec("生视频AI", ("ad",), ("即梦", "dreamina", "可灵", "kling", "Seedance", "Veo", "Sora", "Runway", "manual"), aliases=VIDEO_BACKEND_SETTING_ALIASES, parameterized=True),
    SettingSpec("视频模型路由", ("ad",), ("自动按镜头路由", "固定生视频模型", "固定生视频AI")),
    SettingSpec("视频备用后端", ("ad",), ("无", "即梦", "dreamina", "可灵", "kling", "Seedance", "Veo", "Sora", "Runway", "manual"), aliases=VIDEO_BACKEND_SETTING_ALIASES, parameterized=True),
    SettingSpec("出视频规格", ("ad",), ("预算充足", "预算一般", "预算不够")),
    SettingSpec("视频分辨率", ("ad",), ("720p", "1080p", "4K")),
    SettingSpec("配音后端", ("ad",), ("CosyVoice", "GPT-SoVITS", "MiniMax", "火山", "say占位", "自定义"), parameterized=True),
    SettingSpec("字幕语言", ("ad",), ("中文", "中英双语", "仅英文", "无字幕")),
    SettingSpec("生成粒度", ("ad",), ("逐个", "小批", "按场景分批", "整片", "自定义"), parameterized=True, composite=True),
    SettingSpec("重抽预算策略", ("ad",), ("预算充足", "预算一般")),
    SettingSpec("水印", ("ad",), ("不打", "AI合规标识", "品牌", "AI合规+品牌"), sensitive=True),
    SettingSpec("水印文字", ("ad",), parameterized=True),
    SettingSpec("水印logo文件", ("ad",), parameterized=True),
    SettingSpec("水印位置", ("ad",), ("tl", "tr", "bl", "br", "center"), parameterized=True),
    SettingSpec("水印透明度", ("ad",), parameterized=True),
    SettingSpec("水印大小", ("ad",), parameterized=True),
    SettingSpec("水印-AI合规标识", ("ad",), ("投放前必打", "始终打"), sensitive=True),
    SettingSpec("水印-品牌账号", ("ad",), ("打", "不打")),
    SettingSpec("目标平台", ("ad",), ("抖音", "快手", "B站", "小红书", "YouTube", "TikTok", "视频号", "朋友圈", "OTT电视", "电梯分众", "电商", "跨平台", "未定"), parameterized=True, sensitive=True),
    SettingSpec("发行地区", ("ad",), ("中国大陆", "港澳台", "北美", "东南亚", "全球", "自定义"), parameterized=True, sensitive=True),
    SettingSpec("AI视觉使用披露", ("ad",), ("AI-generated", "AI-assisted", "未使用AI视觉"), sensitive=True),
...
def write_settings(work_root: str, fields: Dict[str, str], *, note: Optional[str] = None, bold_keys: bool = False):
    ...
    lines = ["# 设置 — 本作私有选择点（skills/ad/ad-craft/references/选择点与偏好.md）", ""]
    if note:
        lines += [f"> {note}", ""]
...
def append_record(work_root: str, message: str, *, date: Optional[str] = None) -> None:
    ...
    if not content:
        content = "# 设置 — 本作私有选择点（skills/ad/ad-craft/references/选择点与偏好.md）\n"
