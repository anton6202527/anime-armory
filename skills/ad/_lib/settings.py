...
SETTING_SPECS: Tuple[SettingSpec, ...] = (
    ...
    SettingSpec("水印文字", ("n2d", "mv"), parameterized=True),
    SettingSpec("水印logo文件", ("n2d", "mv"), parameterized=True),
    SettingSpec("水印位置", ("n2d", "mv"), ("tl", "tr", "bl", "br", "center"), parameterized=True),
    SettingSpec("水印透明度", ("n2d", "mv"), parameterized=True),
    SettingSpec("水印大小", ("n2d", "mv"), parameterized=True),
    SettingSpec("水印-AI合规标识", ("n2d",), ("投放前必打", "始终打"), sensitive=True),
    SettingSpec("水印-品牌账号", ("n2d",), ("打", "不打")),
