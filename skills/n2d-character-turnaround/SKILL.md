...
```bash
python3 skills/n2d-character-turnaround/scripts/turnaround.py init \
  --name "角色名" --source reference.png --output role.character-turnaround.json

python3 skills/n2d-character-turnaround/scripts/turnaround.py prepare \
  role.character-turnaround.json --write

python3 skills/n2d-character-turnaround/scripts/turnaround.py validate \
