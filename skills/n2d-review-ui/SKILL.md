...
python3 skills/n2d-review-ui/scripts/episode_app.py <作品根> --episode 第N集 --write --index
python3 skills/n2d-review-ui/scripts/episode_app.py <作品根> --all --write   # 生成所有集工作台 + episode_index.json
```
