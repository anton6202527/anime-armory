...
document.getElementById('reviewBtn').onclick=()=>openMaybe(data.links.review_ui,`先运行：python3 skills/n2d-review-ui/scripts/review_ui.py "${{data.root}}" ${{data.episode}} --write`);
