...
从脚本自身目录跑：
    cd skills/novel/novel-promote/scripts && python3 -m pytest test_record_performance.py
"""
...
score = _load("novel_score", os.path.join(REPO, "skills", "novel", "novel-score", "scripts", "score.py"))
