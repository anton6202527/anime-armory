...
### 1. 生成宣发脚本
```bash
python3 skills/novel/novel-promote/scripts/promo_gen.py "<作品根>" --chapter <章节号> [--platform tiktok]
```
- 读取指定章节。
...
```bash
python3 skills/novel/novel-promote/scripts/record_performance.py "<作品根>" \
