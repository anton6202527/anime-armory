...
EXPAND_INIT = os.path.join(REPO, "skills", "novel", "novel-expand", "scripts", "init_project.py")
CONDENSE_INIT = os.path.join(REPO, "skills", "novel", "novel-condense", "scripts", "init_project.py")
CONTINUE_INIT = os.path.join(REPO, "skills", "novel", "novel-continue", "scripts", "init_project.py")
SPINOFF_INIT = os.path.join(REPO, "skills", "novel", "novel-spinoff", "scripts", "init_project.py")
REWRITE_INIT = os.path.join(REPO, "skills", "novel", "novel-rewrite", "scripts", "init_project.py")
