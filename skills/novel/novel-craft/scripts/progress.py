...
Usage:
    python3 skills/novel/novel-craft/scripts/progress.py <作品根> [--limit 5]
    python3 skills/novel/novel-craft/scripts/progress.py set <作品根> <stage> done|todo
...
COMMON_DIR = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', '..', '_lib'))
