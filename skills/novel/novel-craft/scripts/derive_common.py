...
消除各脚本里逐份复制的 docx→txt / 版权判定，并统一落 `_设置.md`（skills/novel/novel-craft/references/选择点与偏好.md 选择点存储）。
"""
import os
import sys
...
def write_settings(out_root, fields, *, note=None):
    """落 `<作品根>/_设置.md` —— 本作私有选择点（skills/novel/novel-craft/references/选择点与偏好.md 的 per-work 存储）。
