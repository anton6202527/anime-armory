...
Can run without pytest:
    python3 skills/novel/novel-craft/scripts/test_scale_contract.py
"""
...
class ScaleContractTest(unittest.TestCase):
    def test_scale_profiles_match_split_bands(self):
        scripts = [
            "skills/novel/novel-create/scripts/init_project.py",
            "skills/novel/novel-spinoff/scripts/init_project.py",
            "skills/novel/novel-rewrite/scripts/init_project.py",
        ]
