...
ACTION_SCENE_REFERENCE = "skills/novel/novel-craft/references/action-scenes.md"
...
REVEAL_SCENE_REFERENCE = "skills/novel/novel-craft/references/reveal-scenes.md"
CONFRONTATION_SCENE_REFERENCE = "skills/novel/novel-craft/references/confrontation-scenes.md"
RELATIONSHIP_SCENE_REFERENCE = "skills/novel/novel-craft/references/relationship-scenes.md"
SCENE_GUIDES = (
    {
        "key": "action",
...
FEMALE_FICTION_REFERENCE = "skills/novel/novel-craft/references/女频情感.md"
...
SCENE_CARDS_REFERENCE = "skills/novel/novel-craft/references/scene-cards.md"
ARC_SUMMARIES_REL = "设定/arc_summaries.json"
EMOTIONAL_PROGRESS_REL = "设定/emotional_progression.json"
ARC_MEMORY_REFERENCE = "skills/novel/novel-craft/references/arc-memory.md"
...
def knowledge_section_for_chapter(root, chapter):
    ...
    lines.append("> 本章若有人**新得知/开始怀疑/当众揭示**，写完后用 `python3 skills/novel/novel-wiki/scripts/knowledge_sentry.py learn/suspect/reveal` 记账。")
    return "\n".join(lines) + "\n"
...
def observation_packet_section(root, chapter):
    ...
    if os.path.exists(bank_path):
        return (
            ...
            "- 建议先跑 `python3 skills/novel/novel-observe/scripts/observe.py select \"<作品根>\" --chapter "
...
CAST_ARC_REFERENCE = "skills/novel/novel-craft/references/群像与角色弧光.md"
...
- 先跑确定性机检：
```bash
python3 skills/novel/novel-review/scripts/mechanical_check.py "{root}" --range {start}-{end} --json-out "{root}/{batch_json}"
```
