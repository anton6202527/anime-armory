...
The user-facing convention lives in `skills/novel-craft/references/选择点与偏好.md`. This module only
...
class SettingSpec:
    ...
    The prose source of truth remains `skills/novel-craft/references/选择点与偏好.md`; this compact schema
