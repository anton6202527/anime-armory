...
```bash
python3 skills/novel/novel-aesthetic/scripts/aesthetic_bank.py add "<作品根>" \
...
```bash
python3 skills/novel/novel-aesthetic/scripts/aesthetic_bank.py check "<作品根>"
```

4. 为写章/编辑抽取审美对照：

```bash
python3 skills/novel/novel-aesthetic/scripts/aesthetic_bank.py prompt "<作品根>" \
