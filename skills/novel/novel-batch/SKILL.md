...
```bash
python3 skills/novel/novel-batch/scripts/queue.py plan "<作品根>" \
  --kind review \
  --chapters 1-10 \
  --max-retries 1 \
  --priority P1
...
```bash
python3 skills/novel/novel-batch/scripts/queue.py run-one "<作品根>" --worker worker-a --kind review
python3 skills/novel/novel-batch/scripts/queue.py run-one "<作品根>" --worker worker-a --dry-run --json
```
...
```bash
python3 skills/novel/novel-batch/scripts/queue.py mark "<作品根>" \
...
```bash
python3 skills/novel/novel-batch/scripts/queue.py renew "<作品根>" --task-id "<task_id>" --worker worker-a
python3 skills/novel/novel-batch/scripts/queue.py reclaim "<作品根>"
python3 skills/novel/novel-batch/scripts/queue.py dead-letter "<作品根>" --json
python3 skills/novel/novel-batch/scripts/queue.py status "<作品根>"
python3 skills/novel/novel-batch/scripts/queue.py report "<作品根>"
```
