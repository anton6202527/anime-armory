                ...
                "jobs": [
                    {
                        ...
                        "return_command_template": "python3 skills/novel/novel-score/scripts/collect_market_baseline.py ...",
                    }
                ],
...
def test_run_one_dry_run_claims_allowlisted_task_and_marks_skipped():
    with tempfile.TemporaryDirectory() as root:
        ...
        assert "skills/novel/novel-dashboard/scripts/dashboard.py" in result["argv"][1]
        status = q.status()
