...
SKILLS = os.path.join(REPO, "skills", "novel")
...
def actual_novel_skills():
    names = {"novel"} if os.path.isfile(os.path.join(SKILLS, "SKILL.md")) else set()
    names.update({
...
def audit_progress_and_ledgers():
    progress = read("skills/novel/novel-craft/scripts/progress.py")
    draft_packets = read("skills/novel/novel-craft/scripts/draft_packets.py")
    reconcile = read("skills/novel/novel-craft/scripts/reconcile_ledger.py")
    out = []
...
def audit_batch_queue_and_docs():
    out = []
    queue_script = os.path.join(REPO, "skills/novel/novel-craft/scripts/draft_queue.py")
    queue_test = os.path.join(REPO, "skills/novel/novel-craft/scripts/test_draft_queue.py")
    batch_skill = os.path.join(REPO, "skills/novel/novel-batch/SKILL.md")
    batch_queue = os.path.join(REPO, "skills/novel/novel-batch/scripts/queue.py")
    batch_test = os.path.join(REPO, "skills/novel/novel-batch/scripts/test_queue.py")
    craft = read("skills/novel/novel-craft/SKILL.md")
    create = read("skills/novel/novel-create/SKILL.md")
...
def audit_self_audit_docs():
    review = read("skills/novel/novel-review/SKILL.md")
    reference = read("skills/novel/novel-review/references/self_audit.md")
    out = []
