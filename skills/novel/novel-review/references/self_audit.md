...
把"人工复盘整条 novel 线"固化成一条可复跑流程。产出 = 一份**建议报告**（默认不自动改 skill）。
...
```bash
python3 skills/novel/novel-review/scripts/self_audit.py
python3 skills/novel/novel-review/scripts/self_audit.py --project-root "<作品根>"
```
