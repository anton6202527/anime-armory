...
def write_proof_checklist(path, plan):
    lines = [
        ...
        "| 项 | 状态 | 证据/命令 | 备注 |",
        "|---|---|---|---|",
        "| 章节标题与导出目录一致 | ⬜ | `python3 skills/novel/novel-craft/scripts/export.py <作品根> --formats txt,docx,outline` |  |",
        "| review report 绑定当前正文 hash | ⬜ | `python3 skills/novel/novel-craft/scripts/report_gate.py <作品根>` |  |",
        "| score report 绑定当前正文 hash | ⬜ | `python3 skills/novel/novel-score/scripts/score.py <作品根> --scope full` | 商业/平台项目必做 |",
        "| 专业资料包未过期 | ⬜ | `python3 skills/novel/novel-research/scripts/research_pack.py check <作品根>` | 高风险过期阻断 |",
        "| P0/P1 编辑任务已关闭 | ⬜ | `修订/edit_plan.json` | open P0/P1 会阻断作者成书流程进入 release |",
        "| 术语/称谓/style sheet 已核对 | ⬜ | `python3 skills/novel/novel-edit/scripts/style_sheet_check.py <作品根> --write` |  |",
