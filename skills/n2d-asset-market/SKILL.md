...
```bash
python3 skills/n2d-asset-market/scripts/market.py verify-pack 创作区/制漫剧/_资产库/characters/冷宫废妃
```
...
```bash
python3 skills/n2d-asset-market/scripts/market.py import-character <作品根> 创作区/制漫剧/_资产库/characters/冷宫废妃 --as-id CHAR_SHENNIAN --as-name 沈念
...
python3 skills/n2d-asset-market/scripts/market.py import-scene <作品根> 创作区/制漫剧/_资产库/scenes/冷宫寝殿 --as-id LOC_01 --as-name 冷宫寝殿
```
...
python3 skills/n2d-asset-market/scripts/market.py import-prop <作品根> 创作区/制漫剧/_资产库/props/赐死托盘 --as-id PROP_01 --as-name 赐死托盘 --owner CHAR_LIU
```
...
python3 skills/n2d-asset-market/scripts/market.py import-weapon <作品根> 创作区/制漫剧/_资产库/weapons/霜纹长剑 --as-id WEAPON_01 --as-name 霜纹长剑 --owner CHAR_SHEN
```
...
python3 skills/n2d-asset-market/scripts/market.py import-outfit <作品根> 创作区/制漫剧/_资产库/outfits/玄青窄袖官袍 --as-id OUTFIT_01 --as-name 玄青窄袖官袍
```
...
python3 skills/n2d-asset-market/scripts/market.py import-vfx <作品根> 创作区/制漫剧/_资产库/vfx/青白剑气拖尾 --as-id VFX_01 --as-name 青白剑气拖尾
```
...
python3 skills/n2d-asset-market/scripts/market.py import-motif <作品根> 创作区/制漫剧/_资产库/motifs/系统面板
```
...
python3 skills/n2d-asset-market/scripts/market.py import-combat <作品根> 创作区/制漫剧/_资产库/combat/万妖妖力近战 --as-id COMBAT_雷霆近战
```
