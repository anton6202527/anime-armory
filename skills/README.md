...
| 4 出图 | `n2d-image` | 两层出图 prompt（定妆库 + 本集分镜）→ 默认 **Codex only**（Codex 内置/官方 OpenAI 路由）；**禁止 Dreamina/即梦兜底**，除非 `_设置.md` 显式选择 `生图AI: 即梦` |
