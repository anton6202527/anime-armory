...
## 核心原则
- **⛔ 声音克隆合规闸门（non-negotiable·每次确认）**：克隆/复刻/零样本参考音只能是 ①本人嗓 / ②已授权他人嗓 / ③纯合成音色；复刻真人歌手/演员/公众人物需本人授权（2026 opt-in）。这是 CLAUDE.md 列明的"合规/不可逆"点，**即使 `_设置.md` 记过也每次重确认**。脚本侧：`voice_clone.py` 需显式 `VOICE_CLONE_AUTHORIZED=1`。详见 references/cloning.md。
