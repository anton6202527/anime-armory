...
不生产内容，只**审**。是 ad 家族的 QA 环节，与 `n2d-review` / `mv-review` / `novel-review` / `song-review` 同构。两个模式：
...
> ad 线**自包含**：本 skill 只查/对照 ad-* 自己的 skill 和脚本，**绝不 import 或引用 n2d-* / mv-* / novel-* / song-* 任何脚本**。
