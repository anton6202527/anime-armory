...
Anime Armory is a collection of automated workflows (Skills) designed to streamline the transition from raw creative ideas to polished digital assets. It operates on two parallel production lines:
...
1.  **Independence:** The `mv-*` and `n2d-*` lines are strictly independent. Do not share code or skills between them to maintain modularity.
