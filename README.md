...
个人 **AI 创作内容工厂** —— 一套可复用的 Claude Code skills，覆盖 **写小说→制漫剧**、**写歌→制MV** 两组「创作线 × 生产线」，外加公共换脸能力。**私有库**，多台电脑 `git` 同步接着干。
...
- **私有库**：个人成品（写歌/制MV/制漫剧/写小说）与私有偏好均**照常提交**，用于多机同步。
- **将来转干净模板**时，个人成品 + `_设置.md` + `.claude/创作偏好-默认.md` 要留本地不提交——清单见 [`TODO.md`](TODO.md)。
- **版权**：`制漫剧/冷宫有妖气/小说/*.docx`、`写小说/.../原作.txt` 等为版权原文（用户为相关作品作者本人 / 公版 / 已授权）；如需公开先移除版权原文。
- 换脸/克隆真人 = deepfake，强监管：仅本人/授权/合成脸，强制 AI 标识水印，绝不抹标识。
