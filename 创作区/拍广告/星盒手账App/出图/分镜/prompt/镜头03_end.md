...
## 画面 prompt
close-up smartphone, Starbox app concept interface, cards labeled 照片, 语音, 待办 gently moving into 今日手账草稿, clean minimal UI, teal #2E9E97 brand color, warm yellow #F6C85F highlight, Chinese UI text clear and readable, same PROD_STARBOX_APP layout, no third-party app UI

## 身份锁定句
与产品参考图①同一款 App UI、同一 logo、同一品牌色 #2E9E97；同一文字标识“星盒”；UI 文案清晰可读，不乱码。

## 产品/品牌锁
功能为概念动效，避免承诺自动生成结果；UI 状态必须继承 PROD_STARBOX_APP 的卡片式布局。
