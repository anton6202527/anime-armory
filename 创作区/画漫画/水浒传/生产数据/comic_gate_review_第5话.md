...
- 生成时间：2026-07-19T16:59:43
- 结论：warn
- block/warn/info：0 / 134 / 10
...
- drift_report: 追踪 18 角色 · 有漂移 3（跨话汇总·advisory）
...
| info | cross_chapter_drift | 生产数据/comic_identity_drift_report.json | CHAR_SHI_JIN 首崩 第5话：CHAR_SHI_JIN：仅 第5话 单话漂移——按该话 identity report 的 rerun_targets 重抽受影响格即可，先不升重资产。 | identity | 看 comic_identity_drift_report 决定补参考/补服装/补专门定妆或换后端。 |
| info | cross_chapter_drift | 生产数据/comic_identity_drift_report.json | CHAR_WANG_JIN 首崩 第4话：CHAR_WANG_JIN：第4话、第5话 服装漂移——在 registry.assets 的 outfits 子注册登记该换装（描述+参考图+绝不清单），重抽换装格；锁脸锁不住领型/纽扣/花纹。 | identity | 看 comic_identity_drift_report 决定补参考/补服装/补专门定妆或换后端。 |
