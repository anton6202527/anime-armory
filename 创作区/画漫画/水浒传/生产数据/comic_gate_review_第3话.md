...
- 生成时间：2026-07-18T13:35:36
- 结论：pass
- block/warn/info：0 / 0 / 47
...
- drift_report: 追踪 14 角色 · 有漂移 0（跨话汇总·advisory）
...
| info | image | 出图/第3话/panels/P012.png | 疑似烘焙空白气泡已人审签收为误报：放大复核为空白荐书纸面、药包和天光，不是气泡/文字框；药铺重制版已无店招文字。 | comic-review | 若该格重抽或构图变化，需要重新复核原始图空白气泡机检 |
| info | image | 出图/第3话/panels/P020.png | 疑似烘焙空白气泡已人审签收为误报：放大复核为人物手持空白荐书与街巷天光，不是烘焙气泡。 | comic-review | 若该格重抽或构图变化，需要重新复核原始图空白气泡机检 |
| info | image | 出图/第3话/panels/P029.png | 疑似烘焙空白气泡已人审签收为误报：放大复核为宴舞长袖的计划内白色动势前景，不是气泡或文字容器。 | comic-review | 若该格重抽或构图变化，需要重新复核原始图空白气泡机检 |
| info | image | 出图/第3话/panels/P034.png | 疑似烘焙空白气泡已人审签收为误报：放大复核为黄罗礼包与庭院亮部，不是气泡。 | comic-review | 若该格重抽或构图变化，需要重新复核原始图空白气泡机检 |
| info | image | 出图/第3话/panels/P036.png | 疑似烘焙空白气泡已人审签收为误报：放大复核为廊下天光和石地留白，不是气泡。 | comic-review | 若该格重抽或构图变化，需要重新复核原始图空白气泡机检 |
| info | image | 出图/第3话/panels/P038.png | 疑似烘焙空白气泡已人审签收为误报：放大复核为庭院亮空与球路负空间，不含气泡、文字框或可读字。 | comic-review | 若该格重抽或构图变化，需要重新复核原始图空白气泡机检 |
| info | image | 出图/第3话/panels/P039.png | 疑似烘焙空白气泡已人审签收为误报：放大复核为庭院白墙、日光与铺地，不是气泡。 | comic-review | 若该格重抽或构图变化，需要重新复核原始图空白气泡机检 |
| info | image | 出图/第3话/panels/P040.png | 疑似烘焙空白气泡已人审签收为误报：放大复核为廊柱间天光与远处无字礼盒，不是气泡。 | comic-review | 若该格重抽或构图变化，需要重新复核原始图空白气泡机检 |
| info | image | 出图/第3话/panels/P042.png | 疑似烘焙空白气泡已人审签收为误报：放大复核为逆光庭院与石地负空间，不是气泡。 | comic-review | 若该格重抽或构图变化，需要重新复核原始图空白气泡机检 |
| info | image | 出图/第3话/panels/P043.png | 疑似烘焙空白气泡已人审签收为误报：放大复核为殿檐天光与脚—球周围留白，不是气泡。 | comic-review | 若该格重抽或构图变化，需要重新复核原始图空白气泡机检 |
| info | style | 出图/第3话/panels/P002.png | 风格指纹内聚度 0.4662 明显低于本话中位 0.8288，疑似画风、细节密度或照片感跳变。 | comic-review | 已人审签收为计划内画面差异；若后续重抽该格需重新运行风格一致性机检。 |
| info | style | 出图/第3话/panels/P003.png | 风格指纹内聚度 0.6437 明显低于本话中位 0.8288，疑似画风、细节密度或照片感跳变。 | comic-review | 已人审签收为计划内画面差异；若后续重抽该格需重新运行风格一致性机检。 |
| info | style | 出图/第3话/panels/P004.png | 风格指纹内聚度 0.7645 明显低于本话中位 0.8288，疑似画风、细节密度或照片感跳变。 | comic-review | 已人审签收为计划内画面差异；若后续重抽该格需重新运行风格一致性机检。 |
| info | style | 出图/第3话/panels/P006.png | 风格指纹内聚度 0.7774 明显低于本话中位 0.8288，疑似画风、细节密度或照片感跳变。 | comic-review | 已人审签收为计划内画面差异；若后续重抽该格需重新运行风格一致性机检。 |
| info | style | 出图/第3话/panels/P007.png | 风格指纹内聚度 0.7181 明显低于本话中位 0.8288，疑似画风、细节密度或照片感跳变。 | comic-review | 已人审签收为计划内画面差异；若后续重抽该格需重新运行风格一致性机检。 |
| info | style | 出图/第3话/panels/P016.png | 风格指纹内聚度 0.6959 明显低于本话中位 0.8288，疑似画风、细节密度或照片感跳变。 | comic-review | 已人审签收为计划内画面差异；若后续重抽该格需重新运行风格一致性机检。 |
| info | style | 出图/第3话/panels/P017.png | 风格指纹内聚度 0.7606 明显低于本话中位 0.8288，疑似画风、细节密度或照片感跳变。 | comic-review | 已人审签收为计划内画面差异；若后续重抽该格需重新运行风格一致性机检。 |
| info | style | 出图/第3话/panels/P019.png | 风格指纹内聚度 0.7618 明显低于本话中位 0.8288，疑似画风、细节密度或照片感跳变。 | comic-review | 已人审签收为计划内画面差异；若后续重抽该格需重新运行风格一致性机检。 |
| info | style | 出图/第3话/panels/P022.png | 风格指纹内聚度 0.7740 明显低于本话中位 0.8288，疑似画风、细节密度或照片感跳变。 | comic-review | 已人审签收为计划内画面差异；若后续重抽该格需重新运行风格一致性机检。 |
| info | style | 出图/第3话/panels/P030.png | 风格指纹内聚度 0.7716 明显低于本话中位 0.8288，疑似画风、细节密度或照片感跳变。 | comic-review | 已人审签收为计划内画面差异；若后续重抽该格需重新运行风格一致性机检。 |
| info | style | 出图/共享/style_baseline.json | 本话整体指纹与风格锚图最高相似度仅 0.8523，风格锚可能已失去约束力。 | comic-review | 已人审签收为计划内画面差异；若后续重抽该格需重新运行风格一致性机检。 |
