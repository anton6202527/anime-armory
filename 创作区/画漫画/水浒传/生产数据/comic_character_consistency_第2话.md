...
|---|---|---|---|---|---|
| warn | hair_fingerprint_low | CHAR_ABBOT_SHANGQING | P029 | 出图/第2话/panels/P029.png | CHAR_ABBOT_SHANGQING hair 指纹与参考图相似度偏低：score=0.405。这是色彩分布代理，需并排人审。 |
| warn | face_fingerprint_low | CHAR_ABBOT_SHANGQING | P030 | 出图/第2话/panels/P030.png | CHAR_ABBOT_SHANGQING face 指纹与参考图相似度偏低：score=0.428。这是色彩分布代理，需并排人审。 |
| warn | hair_fingerprint_low | CHAR_ABBOT_SHANGQING | P030 | 出图/第2话/panels/P030.png | CHAR_ABBOT_SHANGQING hair 指纹与参考图相似度偏低：score=0.373。这是色彩分布代理，需并排人审。 |
