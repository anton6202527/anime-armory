...
## Prompt
人物运动：手握剑柄、青锋半出鞘，寒光掠过眼前，眼神在重拍处抬起；动作家族：vfx_burst/sword_pose；镜头运动：急推，剑光擦镜形成遮挡切；光影继承：冷青高反差，剑刃高光不过曝；动态细节：发丝、衣摆、光斑或环境粒子随节拍变化；卡点约束：动作峰值对齐 13.28s；转场母题：剑光遮挡切；继承约束：不得重定脸、服装、长剑、场景 setup、光色基调；声音约束：无对白、无旁白、不要生成原生人声。
