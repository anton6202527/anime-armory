...
## Prompt
人物运动：少年独立山门前，风掀白袍，背剑轮廓被雾光勾亮；动作家族：performance_pose/expressive_walk；镜头运动：缓慢推进，雾中显出山门纵深；光影继承：晨雾逆光，青灰石阶冷调；动态细节：发丝、衣摆、光斑或环境粒子随节拍变化；卡点约束：动作峰值对齐 6.6s；转场母题：动作切；继承约束：不得重定脸、服装、长剑、场景 setup、光色基调；声音约束：无对白、无旁白、不要生成原生人声。
