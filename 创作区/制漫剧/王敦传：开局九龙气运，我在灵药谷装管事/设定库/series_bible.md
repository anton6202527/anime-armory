...
| 集 | Clips | 角色 | 资产 | 钩子 | 线程 |
|---|---:|---|---|---|---|
| 第1集 | 35 | CHAR_WANG_DUN、CHAR_JAILER_A、CHAR_JAILER_B、CHAR_PURSUER、CROWD_VALLEY_WORKERS、CHAR_XIAO_LIUZI、CHAR_HE_PINGSHENG | LOC_QI_PRISON_L7、LOC_WASTE_DITCH_BLACK_RIVER、LOC_QI_CITY_LOCKDOWN、LOC_BLACK_RIVER_EXIT、LOC_LINGYAO_VALLEY、LOC_LINGYAO_VALLEY_GATE | 6 | 8 |
| 第2集 | 0 | - | - | 1 | 2 |
| 第3集 | 0 | - | - | 0 | 3 |
| 第4集 | 0 | - | - | 2 | 1 |
| 第5集 | 0 | - | - | 1 | 1 |
