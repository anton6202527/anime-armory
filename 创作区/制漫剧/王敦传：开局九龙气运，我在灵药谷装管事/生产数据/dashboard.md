...
- 生成时间：2026-07-04T03:47:52+00:00
...
|---:|---:|---|---:|---:|---:|---:|---:|---:|---:|
| 10 | 417 | — | 1h53m05s | 49 | 5 | 56 | 292 | 98.0% | 0.0% |

## ROI

| 成片分钟 | 每分钟成本 | 每集耗时 | 一次通过率 | 重抽率 | 投放播放 | 投放收入 | 投放成本 | 净回收 | 回收/生产成本 |
|---:|---|---:|---:|---:|---:|---|---|---|---:|
| 3m37s | — | 1h53m05s | 89.8% | 10.2% | 0 | — | — | — | — |
...
|---|---|---|---|---:|---:|---:|---|---:|---|---:|---:|---:|---:|---:|
| 第1集 | 出图 | — | — | 1h53m05s | 89.8% | 10.2% | manual-第1集 Codex image_generation 真实重出 CHAR_XIAO_LIUZI::定妆_CHAR_XIAO_LIUZI__常态，禁止本地贴脸修复×2；manual-第1集 Codex image_generation 真实重出 CHAR_PURSUER::定妆_CHAR_PURSUER__常态_45度，禁止本地贴脸修复×1；manual-第1集 Codex image_generation 真实重出 CHAR_PURSUER::定妆_CHAR_PURSUER__常态_侧，禁止本地贴脸修复×1 | 56 | — | — | — | — | — | — |
| 第2集 | 阶段1·剧本改编 | — | — | 0s | — | — | — | 0 | — | — | — | — | — | — |
| 第3集 | 阶段1·剧本改编 | — | — | 0s | — | — | — | 0 | — | — | — | — | — | — |
| 第4集 | 阶段1·剧本改编 | — | — | 0s | — | — | — | 0 | — | — | — | — | — | — |
| 第5集 | 阶段1·剧本改编 | — | — | 0s | — | — | — | 0 | — | — | — | — | — | — |
