...
- 生成时间：2026-07-16T11:47:57+00:00
...
|---:|---:|---|---:|---:|---:|---:|---:|---:|---:|
| 10 | 124 | image 20.00 | 2h17m31s | 103 | 9 | 0 | 4 | 66.0% | 66.0% |
...
|---|---|---|---|---:|---:|---:|---|---:|---|---:|---:|---:|---:|---:|
| 第1集 | 出图 | image 20.00 | image 9.24/min | 2h17m31s | 30.1% | 8.7% | 风格锚生成器误继承剧情构图，成图出现具体城寨、兵器、人物与群妖，违反控制资产隔离；修复 n2d-image 后重抽×1；第二抽实际目视仍为具体城寨工作台场景，含建筑、器皿、箱匣、卷轴与伪文字；编译器对 style_anchor 错加人物/兵器剧情通用约束并截断关键负面词，继续修复后重抽×1；full QC 拒收：核心脸锚脸框面积约10%且短边941px，低于≥30%与≥1024px生产门槛；需从同一正面母版更紧方形裁切。×1 | 0 | — | — | — | — | — | — |
| 第2集 | 阶段1·剧本改编 | — | — | 0s | — | — | — | 0 | — | — | — | — | — | — |
| 第3集 | 阶段1·剧本改编 | — | — | 0s | — | — | — | 0 | — | — | — | — | — | — |
| 第4集 | 阶段1·剧本改编 | — | — | 0s | — | — | — | 0 | — | — | — | — | — | — |
| 第5集 | 阶段1·剧本改编 | — | — | 0s | — | — | — | 0 | — | — | — | — | — | — |
