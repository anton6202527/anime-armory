...
- 生成时间：2026-07-16T09:13:01+00:00
...
|---:|---:|---|---:|---:|---:|---:|---:|---:|---:|
| 10 | 102 | — | 2h17m31s | 81 | 5 | 0 | 3 | 64.2% | 64.2% |

## ROI

| 成片分钟 | 每分钟成本 | 每集耗时 | 一次通过率 | 重抽率 | 投放播放 | 投放收入 | 投放成本 | 净回收 | 回收/生产成本 |
|---:|---|---:|---:|---:|---:|---|---|---|---:|
| 2m10s | — | 2h17m31s | 33.3% | 6.2% | 0 | — | — | — | — |
...
|---|---|---|---|---:|---:|---:|---|---:|---|---:|---:|---:|---:|---:|
| 第1集 | 出图 | — | — | 2h17m31s | 33.3% | 6.2% | 风格锚生成器误继承剧情构图，成图出现具体城寨、兵器、人物与群妖，违反控制资产隔离；修复 n2d-image 后重抽×1；第二抽实际目视仍为具体城寨工作台场景，含建筑、器皿、箱匣、卷轴与伪文字；编译器对 style_anchor 错加人物/兵器剧情通用约束并截断关键负面词，继续修复后重抽×1；full QC 拒收：核心脸锚脸框面积约10%且短边941px，低于≥30%与≥1024px生产门槛；需从同一正面母版更紧方形裁切。×1 | 0 | — | — | — | — | — | — |
| 第2集 | 阶段1·剧本改编 | — | — | 0s | — | — | — | 0 | — | — | — | — | — | — |
| 第3集 | 阶段1·剧本改编 | — | — | 0s | — | — | — | 0 | — | — | — | — | — | — |
| 第4集 | 阶段1·剧本改编 | — | — | 0s | — | — | — | 0 | — | — | — | — | — | — |
| 第5集 | 阶段1·剧本改编 | — | — | 0s | — | — | — | 0 | — | — | — | — | — | — |
...
| 维度 | 次数 | 占比 |
|---|---:|---:|
| prompt 冲突 (prompt_conflict) | 2 | 40% |
| 脸漂/身份 (face_consistency) | 2 | 40% |
| 参考图裁切 (reference_crop) | 1 | 20% |
| **一致性小计**（脸漂/服装/场景/画风） | **2** | **40%** |
