...
## 执行层 lint（逐镜 prompt）
- 🟡 13 镜已 lint · block 0 · warn 3
  - 🟡 多视图对齐初筛异常 CHAR_02/常态：身体中心线不齐：rear_three_quarter(0.396) vs front(0.493)，差 0.097>0.055；视平线不齐：front(0.12) vs rear_three_quarter(0.46)，跨视图脸中心高度差 34%>6%；比例不一：front 脸高是 side 的 4.22 倍（>1.35），不是同距离同景别的定妆板——像素几何是可复算启发式证据，按 B10 只报 WARN；最终以逐视图、当前 hash 绑定的人审收据为准。
...
- 确认文件: `/Users/wesley/learn/anime-armory/创作区/制漫剧/从变身少女开始斩妖除魔/生产数据/image_qc/第1集/prop_shape_confirmations.json`
  ...
  - 🟢 Clip_01 图片/Clip01_end.png（PROP_横刀 横刀） 禁形=现代物件、文字水印、结构漂移、数量漂移；尺寸=None；/Users/wesley/learn/anime-armory/创作区/制漫剧/从变身少女开始斩妖除魔/生产数据/image_qc/第1集/prop_shape_review/PROP_横刀_Clip_01_Clip01_end_compare.png
  - 🟢 Clip_01 图片/Clip01_first.png（PROP_横刀 横刀） 禁形=现代物件、文字水印、结构漂移、数量漂移；尺寸=None；/Users/wesley/learn/anime-armory/创作区/制漫剧/从变身少女开始斩妖除魔/生产数据/image_qc/第1集/prop_shape_review/PROP_横刀_Clip_01_Clip01_first_compare.png
  - 🟢 Clip_01 图片/Clip01_end.png（WEAPON_01 横刀） 禁形=变成长剑、华丽仙剑、现代军刀、多把复制、副刀、短刃、匕首、右手第二把刀；尺寸=None；/Users/wesley/learn/anime-armory/创作区/制漫剧/从变身少女开始斩妖除魔/生产数据/image_qc/第1集/prop_shape_review/WEAPON_01_Clip_01_Clip01_end_compare.png
  - 🟢 Clip_01 图片/Clip01_first.png（WEAPON_01 横刀） 禁形=变成长剑、华丽仙剑、现代军刀、多把复制、副刀、短刃、匕首、右手第二把刀；尺寸=None；/Users/wesley/learn/anime-armory/创作区/制漫剧/从变身少女开始斩妖除魔/生产数据/image_qc/第1集/prop_shape_review/WEAPON_01_Clip_01_Clip01_first_compare.png
  - 🟢 Clip_02 图片/Clip02_first.png（PROP_断刀 断刀） 禁形=现代物件、文字水印、结构漂移、数量漂移；尺寸=None；/Users/wesley/learn/anime-armory/创作区/制漫剧/从变身少女开始斩妖除魔/生产数据/image_qc/第1集/prop_shape_review/PROP_断刀_Clip_02_Clip02_first_compare.png
  - 🟢 Clip_02 图片/Clip02_first.png（PROP_横刀 横刀） 禁形=现代物件、文字水印、结构漂移、数量漂移；尺寸=None；/Users/wesley/learn/anime-armory/创作区/制漫剧/从变身少女开始斩妖除魔/生产数据/image_qc/第1集/prop_shape_review/PROP_横刀_Clip_02_Clip02_first_compare.png
  - 🟢 Clip_02 图片/Clip02_first.png（PROP_翻覆囚车 翻覆囚车） 禁形=现代物件、文字水印、结构漂移、数量漂移；尺寸=None；/Users/wesley/learn/anime-armory/创作区/制漫剧/从变身少女开始斩妖除魔/生产数据/image_qc/第1集/prop_shape_review/PROP_翻覆囚车_Clip_02_Clip02_first_compare.png
  - 🟢 Clip_02 图片/Clip02_first.png（WEAPON_01 横刀） 禁形=变成长剑、华丽仙剑、现代军刀、多把复制、副刀、短刃、匕首、右手第二把刀；尺寸=None；/Users/wesley/learn/anime-armory/创作区/制漫剧/从变身少女开始斩妖除魔/生产数据/image_qc/第1集/prop_shape_review/WEAPON_01_Clip_02_Clip02_first_compare.png
