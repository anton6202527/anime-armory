...
|---|---|---|---|---|---|
| 1 | EP01_CLIP01 | LOC_01/未来片段 | 5.14 | 冷开场·CU硬切 | 镜内尾锚（非接力） |
| 2 | EP01_CLIP02 | LOC_01/十分钟前 | 10.747 | dialogue_shot_reverse | 按 seam_mode 剪辑；无尾锚要求 |
...
| 10 | EP01_CLIP10 | LOC_01 | 7.15 | fight_exchange | 镜内尾锚（非接力） |
| 11 | EP01_CLIP11 | LOC_01/百妖谱显化 | 14.641 | system_panel | 按 seam_mode 剪辑；无尾锚要求 |
| 12 | EP01_CLIP12 | LOC_01/系统结算 | 11.642 | system_panel | 按 seam_mode 剪辑；无尾锚要求 |
| 13 | EP01_CLIP13 | LOC_01 | 12.833 | 留白·命债集尾 | 按 seam_mode 剪辑；无尾锚要求 |
