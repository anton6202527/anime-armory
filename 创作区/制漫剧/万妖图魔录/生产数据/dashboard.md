...
- 生成时间：2026-07-12T14:30:48+00:00
- 事件日志：`/Users/lalala/learn/anime-armory/创作区/制漫剧/万妖图魔录/生产数据/production_events.jsonl`
...
|---:|---:|---|---:|---:|---:|---:|---:|---:|---:|
| 10 | 47 | — | 38m08s | 14 | 0 | 0 | 24 | 92.9% | 92.9% |

## ROI

| 成片分钟 | 每分钟成本 | 每集耗时 | 一次通过率 | 重抽率 | 投放播放 | 投放收入 | 投放成本 | 净回收 | 回收/生产成本 |
|---:|---|---:|---:|---:|---:|---|---|---|---:|
| 2m07s | — | 38m08s | 92.9% | 0.0% | 0 | — | — | — | — |
