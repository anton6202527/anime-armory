...
- generated_at: 2026-07-06T06:45:46+00:00
- 告警数: 6（critical 2 / warn 4）

| 级别 | 类型 | 范围 | 说明 |
|---|---|---|---|
| 🔴 critical | qa_blockers | totals | QA 阻断 659 项（阈值 >0）；先按 recent_blockers 修复再继续付费生成 |
...
| 🟡 warn | qa_blockers | 第2集 | 第2集 QA 阻断 6 项 |
| 🟡 warn | qa_blockers | 第3集 | 第3集 QA 阻断 359 项 |
| 🟡 warn | qa_blockers | 第4集 | 第4集 QA 阻断 26 项 |
