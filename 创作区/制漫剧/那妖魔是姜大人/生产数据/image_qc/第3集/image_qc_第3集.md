...
- episode: 第3集
- 总判定: **review** · 硬阻断 0（必须修） · 非阻断初筛 13 · 视觉降级 0
...
## 本集图片命名空间（硬闸）
- 🟢 当前 prompt 声明目标 20 张；未声明 live Clip PNG 0 张
...
## 角色脸定妆比对覆盖（硬闸）
- 🟢 已落档角色图 required 6 · covered 6 · missing 0 · pending 14 · precision full
- 人工脸部确认: applied 4 · 确认文件 `/Users/wesley/learn/anime-armory/创作区/制漫剧/那妖魔是姜大人/生产数据/image_qc/第3集/face_confirmations.json`
...
## 高风险道具禁形/尺寸逐图复核（硬闸）
- total 15 · pending 0 · confirmed 15
