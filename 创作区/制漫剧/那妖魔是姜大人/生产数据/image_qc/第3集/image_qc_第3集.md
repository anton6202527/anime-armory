...
- episode: 第3集
- 总判定: **block** · 硬阻断 9（必须修） · 非阻断初筛 21 · 视觉降级 0
...
## 角色脸定妆比对覆盖（硬闸）
- 🔴 已落档角色图 required 17 · covered 16 · missing 1 · pending 0 · precision full
  - 🔴 镜头 6（`EP03_CLIP06` · 陈情与硬装 · dialogue_shot_reverse） 图片/EP03_CLIP06_a3.png：face_verdict_noface
- 人工脸部确认: applied 10 · 确认文件 `/Users/wesley/learn/anime-armory/创作区/制漫剧/那妖魔是姜大人/生产数据/image_qc/第3集/face_confirmations.json`

## 核心角色五角 turnaround（逐视图 hash 收据硬闸）
- 🟢 checked forms 5 · pending/stale receipts 0 · contract `front/three_quarter/side/rear_three_quarter/back`
- 像素头顶/脚底/中心线/身高与脸框只作 WARN 级可复算证据；硬条件仅是当前 PNG 的逐视图 pass 收据。

## 跨集脸漂移趋势（B·治每集过floor但逐集偏离·advisory）
- 🟡 CHAR_01__囚途残损态：第1集→第3集 均值 0.3531→0.4078（掉幅 -0.0547）（跌破绝对下限）
- 🔴 CHAR_02__濒死重伤态：第1集→第3集 均值 0.4424→0.1918（掉幅 0.2506）（跌破绝对下限）
...
## 执行层 lint（逐镜 prompt）
- 🔴 8 镜已 lint · block 7 · warn 7
  - 🔴 镜头 1（`EP03_CLIP01` · 众人跪求的假大人 · ensemble_blocking）：打斗/动作镜含清晰正脸/frontal portrait 倾向，容易把拆招拍成看镜头摆拍；改为可辨三分之二侧脸/侧脸/背身侧轮廓，并明确不与主镜头对视。
  - 🔴 镜头 3（`EP03_CLIP03` · 黑衣赤纹换装 · dialogue_shot_reverse）：正向 prompt 写了「黑衣」类服饰/形态，但资产身份注册层绑定 `CHAR_01/“囚途残损态”` （asset_key=CHAR_01__囚途残损态）没有对应服饰定妆。换装/形态变体必须新建独立 `CHAR_xx/形态`、wardrobe_profile 和 reference_group，禁止复用其它服饰状态参考。
  - 🔴 镜头 5（`EP03_CLIP05` · 马队急停试探 · ensemble_blocking）：打斗/动作镜含清晰正脸/frontal portrait 倾向，容易把拆招拍成看镜头摆拍；改为可辨三分之二侧脸/侧脸/背身侧轮廓，并明确不与主镜头对视。
  - 🔴 镜头 6（`EP03_CLIP06` · 陈情与硬装 · dialogue_shot_reverse）：打斗/动作镜含清晰正脸/frontal portrait 倾向，容易把拆招拍成看镜头摆拍；改为可辨三分之二侧脸/侧脸/背身侧轮廓，并明确不与主镜头对视。
  - 🔴 镜头 7（`EP03_CLIP07` · 百十条人命压身 · ensemble_blocking）：打斗/动作镜含清晰正脸/frontal portrait 倾向，容易把拆招拍成看镜头摆拍；改为可辨三分之二侧脸/侧脸/背身侧轮廓，并明确不与主镜头对视。
  - 🔴 镜头 8（`EP03_CLIP08` · 被迫接局·集尾 · ensemble_blocking）：打斗/动作镜含清晰正脸/frontal portrait 倾向，容易把拆招拍成看镜头摆拍；改为可辨三分之二侧脸/侧脸/背身侧轮廓，并明确不与主镜头对视。
  - 🔴 镜头 8（`EP03_CLIP08` · 被迫接局·集尾 · ensemble_blocking）：正向 prompt 写了「黑衣」类服饰/形态，但资产身份注册层绑定 `CHAR_01/“囚途残损态”` （asset_key=CHAR_01__囚途残损态）没有对应服饰定妆。换装/形态变体必须新建独立 `CHAR_xx/形态`、wardrobe_profile 和 reference_group，禁止复用其它服饰状态参考。
...
## 高风险道具禁形/尺寸逐图复核（硬闸）
- total 40 · pending 0 · confirmed 40
- 确认文件: `/Users/wesley/learn/anime-armory/创作区/制漫剧/那妖魔是姜大人/生产数据/image_qc/第3集/prop_shape_confirmations.json`
  ...
  - 🟢 Clip_03 图片/Clip03_end.png（PROP_镇魔司制服 镇魔司制服） 禁形=现代物件、文字水印、结构漂移、数量漂移；尺寸=None；/Users/wesley/learn/anime-armory/创作区/制漫剧/那妖魔是姜大人/生产数据/image_qc/第3集/prop_shape_review/PROP_镇魔司制服_Clip_03_Clip03_end_compare.png
  ...
  - 🟢 Clip_03 图片/Clip03_end.png（WEAPON_01 横刀） 禁形=变成长剑、华丽仙剑、现代军刀、多把复制、副刀、短刃、匕首、右手第二把刀；尺寸=None；/Users/wesley/learn/anime-armory/创作区/制漫剧/那妖魔是姜大人/生产数据/image_qc/第3集/prop_shape_review/WEAPON_01_Clip_03_Clip03_end_compare.png
  ...
  - 🟢 Clip_03 图片/Clip03_end.png（WEAPON_横刀 横刀） 禁形=变成长剑、华丽仙剑、现代军刀、多把复制、副刀、短刃、匕首、右手第二把刀；尺寸=None；/Users/wesley/learn/anime-armory/创作区/制漫剧/那妖魔是姜大人/生产数据/image_qc/第3集/prop_shape_review/WEAPON_横刀_Clip_03_Clip03_end_compare.png
  ...
  - 🟢 Clip_06 图片/EP03_CLIP06_a1.png（WEAPON_01 横刀） 禁形=变成长剑、华丽仙剑、现代军刀、多把复制、副刀、短刃、匕首、右手第二把刀；尺寸=None；/Users/wesley/learn/anime-armory/创作区/制漫剧/那妖魔是姜大人/生产数据/image_qc/第3集/prop_shape_review/WEAPON_01_Clip_06_EP03_CLIP06_a1_compare.png
  - 🟢 Clip_06 图片/EP03_CLIP06_a2.png（WEAPON_01 横刀） 禁形=变成长剑、华丽仙剑、现代军刀、多把复制、副刀、短刃、匕首、右手第二把刀；尺寸=None；/Users/wesley/learn/anime-armory/创作区/制漫剧/那妖魔是姜大人/生产数据/image_qc/第3集/prop_shape_review/WEAPON_01_Clip_06_EP03_CLIP06_a2_compare.png
  - 🟢 Clip_06 图片/EP03_CLIP06_a3.png（WEAPON_01 横刀） 禁形=变成长剑、华丽仙剑、现代军刀、多把复制、副刀、短刃、匕首、右手第二把刀；尺寸=None；/Users/wesley/learn/anime-armory/创作区/制漫剧/那妖魔是姜大人/生产数据/image_qc/第3集/prop_shape_review/WEAPON_01_Clip_06_EP03_CLIP06_a3_compare.png
  ...
  - 🟢 Clip_06 图片/EP03_CLIP06_a1.png（WEAPON_横刀 横刀） 禁形=变成长剑、华丽仙剑、现代军刀、多把复制、副刀、短刃、匕首、右手第二把刀；尺寸=None；/Users/wesley/learn/anime-armory/创作区/制漫剧/那妖魔是姜大人/生产数据/image_qc/第3集/prop_shape_review/WEAPON_横刀_Clip_06_EP03_CLIP06_a1_compare.png
  - 🟢 Clip_06 图片/EP03_CLIP06_a2.png（WEAPON_横刀 横刀） 禁形=变成长剑、华丽仙剑、现代军刀、多把复制、副刀、短刃、匕首、右手第二把刀；尺寸=None；/Users/wesley/learn/anime-armory/创作区/制漫剧/那妖魔是姜大人/生产数据/image_qc/第3集/prop_shape_review/WEAPON_横刀_Clip_06_EP03_CLIP06_a2_compare.png
  - 🟢 Clip_06 图片/EP03_CLIP06_a3.png（WEAPON_横刀 横刀） 禁形=变成长剑、华丽仙剑、现代军刀、多把复制、副刀、短刃、匕首、右手第二把刀；尺寸=None；/Users/wesley/learn/anime-armory/创作区/制漫剧/那妖魔是姜大人/生产数据/image_qc/第3集/prop_shape_review/WEAPON_横刀_Clip_06_EP03_CLIP06_a3_compare.png
  - 🟢 Clip_07 图片/Clip07_end.png（WEAPON_01 横刀） 禁形=变成长剑、华丽仙剑、现代军刀、多把复制、副刀、短刃、匕首、右手第二把刀；尺寸=None；/Users/wesley/learn/anime-armory/创作区/制漫剧/那妖魔是姜大人/生产数据/image_qc/第3集/prop_shape_review/WEAPON_01_Clip_07_Clip07_end_compare.png
  ...
  - 🟢 Clip_07 图片/Clip07_end.png（WEAPON_横刀 横刀） 禁形=变成长剑、华丽仙剑、现代军刀、多把复制、副刀、短刃、匕首、右手第二把刀；尺寸=None；/Users/wesley/learn/anime-armory/创作区/制漫剧/那妖魔是姜大人/生产数据/image_qc/第3集/prop_shape_review/WEAPON_横刀_Clip_07_Clip07_end_compare.png
  ...
  - 🟢 Clip_08 图片/Clip08_end.png（WEAPON_01 横刀） 禁形=变成长剑、华丽仙剑、现代军刀、多把复制、副刀、短刃、匕首、右手第二把刀；尺寸=None；/Users/wesley/learn/anime-armory/创作区/制漫剧/那妖魔是姜大人/生产数据/image_qc/第3集/prop_shape_review/WEAPON_01_Clip_08_Clip08_end_compare.png
  ...
  - 🟢 Clip_08 图片/Clip08_end.png（WEAPON_横刀 横刀） 禁形=变成长剑、华丽仙剑、现代军刀、多把复制、副刀、短刃、匕首、右手第二把刀；尺寸=None；/Users/wesley/learn/anime-armory/创作区/制漫剧/那妖魔是姜大人/生产数据/image_qc/第3集/prop_shape_review/WEAPON_横刀_Clip_08_Clip08_end_compare.png
