...
## 角色脸定妆比对覆盖（硬闸）
- 🟢 已落档角色图 required 5 · covered 5 · missing 0 · pending 14 · precision full
...
## 高风险道具禁形/尺寸逐图复核（硬闸）
- total 13 · pending 2 · confirmed 11
- 确认文件: `/Users/wesley/learn/anime-armory/创作区/制漫剧/那妖魔是姜大人/生产数据/image_qc/第2集/prop_shape_confirmations.json`
  ...
  - 🔴 Clip_03 图片/EP02_CLIP02_preimpact.png（WEAPON_01 横刀） 禁形=变成长剑、华丽仙剑、现代军刀、多把复制、副刀、短刃、匕首、右手第二把刀；尺寸=None；/Users/wesley/learn/anime-armory/创作区/制漫剧/那妖魔是姜大人/生产数据/image_qc/第2集/prop_shape_review/WEAPON_01_Clip_03_EP02_CLIP02_preimpact_compare.png
  - 🔴 Clip_03 图片/EP02_CLIP02_preimpact.png（WEAPON_横刀 横刀） 禁形=变成长剑、华丽仙剑、现代军刀、多把复制、副刀、短刃、匕首、右手第二把刀；尺寸=None；/Users/wesley/learn/anime-armory/创作区/制漫剧/那妖魔是姜大人/生产数据/image_qc/第2集/prop_shape_review/WEAPON_横刀_Clip_03_EP02_CLIP02_preimpact_compare.png
