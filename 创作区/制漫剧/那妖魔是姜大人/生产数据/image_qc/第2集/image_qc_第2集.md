...
- episode: 第2集
- 总判定: **review** · 硬阻断 0（必须修） · 非阻断初筛 44 · 视觉降级 0
...
- 人工脸部确认: applied 4 · 确认文件 `/Users/wesley/learn/anime-armory/创作区/制漫剧/那妖魔是姜大人/生产数据/image_qc/第2集/face_confirmations.json`
...
- 🟡 CHAR_01__囚途残损态：第1集→第2集 均值 0.3531→0.3988（掉幅 -0.0457）（跌破绝对下限）
...
## 高风险道具禁形/尺寸逐图复核（硬闸）
- total 29 · pending 0 · confirmed 29
