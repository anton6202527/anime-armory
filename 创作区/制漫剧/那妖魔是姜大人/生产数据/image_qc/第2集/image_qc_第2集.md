...
- episode: 第2集
- 总判定: **block** · 硬阻断 5（必须修） · 非阻断初筛 34 · 视觉降级 0
...
## 角色脸定妆比对覆盖（硬闸）
- 🟢 已落档角色图 required 16 · covered 16 · missing 0 · pending 3 · precision full
...
- 🟡 CHAR_01__囚途残损态：第1集→第2集 均值 0.3531→0.4291（掉幅 -0.076）（跌破绝对下限）
...
## 高风险道具禁形/尺寸逐图复核（硬闸）
- total 26 · pending 2 · confirmed 24
