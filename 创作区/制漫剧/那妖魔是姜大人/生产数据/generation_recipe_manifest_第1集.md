...
|---|---|---|---|---|
| `出图/第1集/图片/Clip01_end.png` | image | pass | - | `生产数据/production_events.jsonl:line 46` |
| `出图/第1集/图片/Clip01_first.png` | image | pass | - | `生产数据/production_events.jsonl:line 44` |
| `出图/第1集/图片/Clip01_mid.png` | image | pass | - | `生产数据/production_events.jsonl:line 45` |
| `出图/第1集/图片/Clip02_end.png` | image | pass | - | `生产数据/production_events.jsonl:line 80` |
| `出图/第1集/图片/Clip02_first.png` | image | pass | - | `生产数据/production_events.jsonl:line 78` |
| `出图/第1集/图片/Clip02_mid.png` | image | pass | - | `生产数据/production_events.jsonl:line 79` |
| `出图/第1集/图片/Clip03_end.png` | image | pass | - | `生产数据/production_events.jsonl:line 52` |
| `出图/第1集/图片/Clip03_first.png` | image | pass | - | `生产数据/production_events.jsonl:line 50` |
| `出图/第1集/图片/Clip03_mid.png` | image | pass | - | `生产数据/production_events.jsonl:line 51` |
| `出图/第1集/图片/Clip04_end.png` | image | pass | - | `生产数据/production_events.jsonl:line 83` |
| `出图/第1集/图片/Clip04_first.png` | image | pass | - | `生产数据/production_events.jsonl:line 81` |
| `出图/第1集/图片/Clip04_mid.png` | image | pass | - | `生产数据/production_events.jsonl:line 82` |
| `出图/第1集/图片/Clip05_end.png` | image | pass | - | `生产数据/production_events.jsonl:line 86` |
...
| `出图/第1集/图片/Clip08_end.png` | image | pass | - | `生产数据/production_events.jsonl:line 95` |
| `出图/第1集/图片/Clip08_first.png` | image | pass | - | `生产数据/production_events.jsonl:line 93` |
| `出图/第1集/图片/Clip08_mid.png` | image | pass | - | `生产数据/production_events.jsonl:line 94` |
| `出图/第1集/图片/Clip09_end.png` | image | pass | - | `生产数据/production_events.jsonl:line 70` |
| `出图/第1集/图片/Clip09_first.png` | image | pass | - | `生产数据/production_events.jsonl:line 68` |
| `出图/第1集/图片/Clip09_mid.png` | image | pass | - | `生产数据/production_events.jsonl:line 69` |
| `出图/第1集/图片/Clip10_end.png` | image | pass | - | `生产数据/production_events.jsonl:line 73` |
