...
| 角色 | 风险 | 分 | 锁脸档 | 主驱动 |
|---|---|---|---|---|
| 姜月初（CHAR_01/囚犯初醒态） | 🔴 high | 85.5 | multi_reference | 极端角度 4 镜(+24)；近景占比 6/8(+22.5)；锁脸档位=multi_reference(+22) |
...
| `VFX_残余金纹`（vfx） | faceless | 🟢 low | faceless·须背身/裁脸·落档像素验 0 清晰脸 |
| `VFX_系统面板`（vfx） | faceless | 🟢 low | faceless·须背身/裁脸·落档像素验 0 清晰脸 |
