...
- 生成时间：2026-07-22T06:25:39+00:00
...
|---:|---:|---|---:|---:|---:|---:|---:|---:|---:|
| 10 | 553 | credits 1624.00 | 3h13m45s | 153 | 40 | 117 | 198 | 100.0% | 0.0% |

## ROI

| 成片分钟 | 每分钟成本 | 每集耗时 | 一次通过率 | 重抽率 | 投放播放 | 投放收入 | 投放成本 | 净回收 | 回收/生产成本 |
|---:|---|---:|---:|---:|---:|---|---|---|---:|
| 1m18s | credits 1257.29/min | 3h13m45s | 40.5% | 26.1% | 0 | — | — | — | — |
...
|---|---|---|---|---:|---:|---:|---|---:|---|---:|---:|---:|---:|---:|
| 第1集 | 合成成片 | credits 1624.00 | credits 1257.29/min | 3h13m44s | 40.1% | 26.3% | 配方 schema 补全（像素未改）×11；配方 provider 补全（像素未改）×11；刀刃误指颈部，精确下移至胸骨前且未接触×1 | 117 | — | — | — | — | — | — |
| 第2集 | 声音选角 / 时间基准 / 最终配音 | — | — | 1s | 100.0% | 0.0% | — | 0 | — | — | — | — | — | — |
| 第3集 | 阶段1·剧本改编 | — | — | 0s | — | — | — | 0 | — | — | — | — | — | — |
| 第4集 | 阶段1·剧本改编 | — | — | 0s | — | — | — | 0 | — | — | — | — | — | — |
| 第5集 | 阶段1·剧本改编 | — | — | 0s | — | — | — | 0 | — | — | — | — | — | — |
| 第6集 | 阶段1·剧本改编 | — | — | 0s | — | — | — | 0 | — | — | — | — | — | — |
