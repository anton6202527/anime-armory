...
- 生成时间：2026-07-23T01:41:38+00:00
...
|---:|---:|---|---:|---:|---:|---:|---:|---:|---:|
| 10 | 1032 | credits 3208.00 | 3h49m04s | 359 | 40 | 179 | 399 | 100.0% | 0.0% |

## ROI

| 成片分钟 | 每分钟成本 | 每集耗时 | 一次通过率 | 重抽率 | 投放播放 | 投放收入 | 投放成本 | 净回收 | 回收/生产成本 |
|---:|---|---:|---:|---:|---:|---|---|---|---:|
| 2m29s | credits 1288.12/min | 3h49m04s | 67.4% | 11.1% | 0 | — | — | — | — |
...
|---|---|---|---|---:|---:|---:|---|---:|---|---:|---:|---:|---:|---:|
| 第1集 | 合成成片 | credits 1624.00 | credits 1257.29/min | 3h13m44s | 39.9% | 26.1% | 配方 schema 补全（像素未改）×11；配方 provider 补全（像素未改）×11；刀刃误指颈部，精确下移至胸骨前且未接触×1 | 117 | — | — | — | — | — | — |
| 第2集 | 视频prompt | credits 1584.00 | credits 1321.34/min | 35m20s | 87.9% | 0.0% | — | 62 | — | — | — | — | — | — |
| 第3集 | 阶段1·剧本改编 | — | — | 0s | — | — | — | 0 | — | — | — | — | — | — |
| 第4集 | 阶段1·剧本改编 | — | — | 0s | — | — | — | 0 | — | — | — | — | — | — |
| 第5集 | 阶段1·剧本改编 | — | — | 0s | — | — | — | 0 | — | — | — | — | — | — |
| 第6集 | 阶段1·剧本改编 | — | — | 0s | — | — | — | 0 | — | — | — | — | — | — |
...
| 其他 (other) | 23 | 57% |
| 时序/接缝 (temporal) | 7 | 18% |
| 道具/特效 (prop_structure) | 4 | 10% |
| 参考图裁切 (reference_crop) | 4 | 10% |
| 脸漂/身份 (face_consistency) | 2 | 5% |
| **一致性小计**（脸漂/服装/场景/画风） | **2** | **5%** |
...
|---|---|---:|---:|---:|---:|---|
| 第1集 | blocked | 10 | 5 | 0 | 13 | 姜月初(block)；裴长青(medium)；虎妖(medium) |
| 第2集 | blocked | 9 | 7 | 0 | 10 | 姜月初(block)；裴长青(block)；虎妖(medium) |
