...
- 生成时间：2026-07-29T12:46:41+00:00
...
|---:|---:|---|---:|---:|---:|---:|---:|---:|---:|
| 10 | 1753 | credits 3872.00 | 17h14m43s | 578 | 76 | 357 | 661 | 92.3% | 0.0% |

## ROI

| 成片分钟 | 每分钟成本 | 每集耗时 | 一次通过率 | 重抽率 | 投放播放 | 投放收入 | 投放成本 | 净回收 | 回收/生产成本 |
|---:|---|---:|---:|---:|---:|---|---|---|---:|
| 3m58s | credits 975.07/min | 17h14m43s | 57.3% | 13.2% | 0 | — | — | — | — |
...
| 第3集 | 图生视频 | — | — | 7h40m39s | 33.0% | 32.0% | 补录当前像素的完整强配方 schema 与不可用 seed 降级证据；像素不变。×8；补齐正式媒体生成证据必填字段；当前像素不变。×5；补齐正式媒体实际图像输入清单；当前像素不变。×5 | 42 | — | — | — | — | — | — |
| 第4集 | 阶段1·剧本改编 | — | — | 0s | — | — | — | 0 | — | — | — | — | — | — |
| 第5集 | 阶段1·剧本改编 | — | — | 0s | — | — | — | 0 | — | — | — | — | — | — |
| 第6集 | 阶段1·剧本改编 | — | — | 0s | — | — | — | 0 | — | — | — | — | — | — |
| 第7集 | 阶段1·剧本改编 | — | — | 0s | — | — | — | 0 | — | — | — | — | — | — |
