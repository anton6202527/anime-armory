...
- 生成时间：2026-07-03T14:20:12+00:00
...
|---:|---:|---|---:|---:|---:|---:|---:|---:|---:|
| 10 | 802 | credits 2302.00 | 14h35m42s | 191 | 13 | 249 | 302 | 95.8% | 0.0% |

## ROI

| 成片分钟 | 每分钟成本 | 每集耗时 | 一次通过率 | 重抽率 | 投放播放 | 投放收入 | 投放成本 | 净回收 | 回收/生产成本 |
|---:|---|---:|---:|---:|---:|---|---|---|---:|
| 3m54s | credits 590.90/min | 14h35m42s | 92.2% | 6.8% | 0 | — | — | — | — |
...
|---|---|---|---|---:|---:|---:|---|---:|---|---:|---:|---:|---:|---:|
| 第1集 | 审查验收 | credits 2302.00 | credits 1146.08/min | 8h11m19s | 99.2% | 0.0% | — | 243 | — | — | — | — | — | — |
...
- 第2集 / image / 出图落档QC: 创作区/制漫剧/那妖魔是姜大人/生产数据/image_qc/第2集/image_qc_第2集.json — 发现未入账 image_qc 报告但其新鲜度为 `stale`：报告 `inputs_fingerprint` 与当前文件失配：出图/共享/asset_registry.json(变更)、出图/共享/identity_registry.json(变更)。先重跑 `dashboard gate --stage image` 或 image_qc，不能用旧报告证明图片一致。
