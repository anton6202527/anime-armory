...
- 生成时间：2026-07-28T10:27:58+00:00
...
|---:|---:|---|---:|---:|---:|---:|---:|---:|---:|
| 10 | 1791 | credits 3872.00 | 11h59m40s | 510 | 46 | 477 | 651 | 92.2% | 0.0% |

## ROI

| 成片分钟 | 每分钟成本 | 每集耗时 | 一次通过率 | 重抽率 | 投放播放 | 投放收入 | 投放成本 | 净回收 | 回收/生产成本 |
|---:|---|---:|---:|---:|---:|---|---|---|---:|
| 3m58s | credits 975.07/min | 11h59m40s | 62.2% | 9.0% | 0 | — | — | — | — |
...
| 第3集 | 出图 | — | — | 2h25m36s | 62.1% | 3.5% | runner 两版均漏掉签名装备；基于当前帧和横刀母版局部编辑，补正确左髋单刀挂载。×1 | 162 | — | — | — | — | — | — |
| 第4集 | 阶段1·剧本改编 | — | — | 0s | — | — | — | 0 | — | — | — | — | — | — |
| 第5集 | 阶段1·剧本改编 | — | — | 0s | — | — | — | 0 | — | — | — | — | — | — |
| 第6集 | 阶段1·剧本改编 | — | — | 0s | — | — | — | 0 | — | — | — | — | — | — |
| 第7集 | 阶段1·剧本改编 | — | — | 0s | — | — | — | 0 | — | — | — | — | — | — |
...
| 第3集 | blocked | 10 | 9 | 0 | 8 | 姜月初(block)；03(block)；裴长青(block) |
