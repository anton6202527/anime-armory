...
| 角色 | ⛔ block | 33 | 0 | 73 | detect, gate:image_preflight, gate:image_prompt_preflight, gate:image |
| 资产 | ⛔ block | 10 | 0 | 5 | detect, gate:image_preflight, gate:image_prompt_preflight, gate:image |
| 镜头 | ⛔ block | 4 | 0 | 75 | detect, gate:image_preflight, gate:image_prompt_preflight, gate:image |
| 音频 | ⛔ block | 6 | 0 | 17 | detect, gate:image_preflight, gate:image_prompt_preflight, gate:image |
| 字幕 | 🟡 warn | 0 | 0 | 9 | detect |
| 合规 | 🟡 warn | 0 | 0 | 4 | detect, gate:image_preflight, gate:image_prompt_preflight, gate:image, compliance |
| 生产操作 | ⛔ block | 3 | 0 | 57 | detect, gate:image_preflight, gate:image_prompt_preflight, gate:image, score, expression_state_consistency |
...
- warn [gate:image] 跨集色调 @ /Users/wesley/learn/anime-armory/创作区/制漫剧/那妖魔是姜大人/脚本/第2集/storyboard.json: 跨集色调 本集色调基线基调「冷青灰夜色为主」与打样集 第1集「冷青灰荒野+土褐枯草+黑血暗红」不一致——色调可逐集细化但基调应跨集恒定；以打样集为准或确认有意改（防整部画风跳）
...
- block · asset:asset · 物件状态(OST) / 结构化交互图谱(I2) / 系统面板(UI1)
  - warn [detect] 物件状态(OST):  物件状态(OST)   道具『横刀』状态前后矛盾：EP02_CLIP07 写「满」（满），EP02_CLIP08 写「空」（空），中间无已声明的状态转换——若确有变化请在 visual_state_ledger 给该道具登记 timeline 转换，否则修穿帮。 
  - block [detect] 结构化交互图谱(I2):  结构化交互图谱(I2)   接触/持有镜缺结构化 interaction_graph；自由文本提示无法稳定约束接触点、身体部位归属与遮挡顺序。 
  - block [detect] 结构化交互图谱(I2):  结构化交互图谱(I2)   接触/持有镜缺结构化 interaction_graph；自由文本提示无法稳定约束接触点、身体部位归属与遮挡顺序。 
...
- block · character:image_qc_第2集.json · 出图落档QC
  - block [gate:image] 出图落档QC @ /Users/wesley/learn/anime-armory/创作区/制漫剧/那妖魔是姜大人/生产数据/image_qc/第2集/image_qc_第2集.json: 出图落档QC 输入首帧 image_qc 仍有 1 项硬阻断（崩脸/接缝断/降级精度近景/非法 CHAR）——图生视频会忠实把这些缺陷动起来，是最贵工位上的纯浪费。先回 n2d-image 修复并重跑 image_qc 再出视频。
- block · character:图片 · 锚点门(N3) / 跨集脸漂(G5) / 服装配色(N1) / 发型(H1)
  - block [gate:image] 锚点门(N3) @ 出图/共享/图片: 锚点门(N3) 一致性审计发现问题
  - block [gate:image] 跨集脸漂(G5) @ 出图/共享/图片: 跨集脸漂(G5) CHAR_01__囚犯初醒态 跨集脸漂：第1集(均值0.427)→第2集(均值0.3627)，相对基线掉幅 0.0643，且本集均值低于绝对下限——已系统性偏离定妆锚
  - warn [gate:image] 锚点门(N3) @ 出图/共享/图片: 锚点门(N3) 一致性审计发现问题
- block · character:定妆_CHAR_01__囚犯初醒态_正面.png · 资产身份注册层
  - block [gate:image] 资产身份注册层 @ /Users/wesley/learn/anime-armory/创作区/制漫剧/那妖魔是姜大人/出图/共享/图片/定妆_CHAR_01__囚犯初醒态_正面.png: 资产身份注册层 three_quarter 同源派生 source_sha256 与当前母本不一致；母本变更后必须重新裁切派生。
  - block [gate:image] 资产身份注册层 @ /Users/wesley/learn/anime-armory/创作区/制漫剧/那妖魔是姜大人/出图/共享/图片/定妆_CHAR_01__囚犯初醒态_正面.png: 资产身份注册层 side 同源派生 source_sha256 与当前母本不一致；母本变更后必须重新裁切派生。
  - block [gate:image] 资产身份注册层 @ /Users/wesley/learn/anime-armory/创作区/制漫剧/那妖魔是姜大人/出图/共享/图片/定妆_CHAR_01__囚犯初醒态_正面.png: 资产身份注册层 back 同源派生 source_sha256 与当前母本不一致；母本变更后必须重新裁切派生。
- block · character:定妆_CHAR_02__濒死战损态_正面.png · 资产身份注册层
  - block [gate:image] 资产身份注册层 @ /Users/wesley/learn/anime-armory/创作区/制漫剧/那妖魔是姜大人/出图/共享/图片/定妆_CHAR_02__濒死战损态_正面.png: 资产身份注册层 three_quarter 同源派生 source_sha256 与当前母本不一致；母本变更后必须重新裁切派生。
  - block [gate:image] 资产身份注册层 @ /Users/wesley/learn/anime-armory/创作区/制漫剧/那妖魔是姜大人/出图/共享/图片/定妆_CHAR_02__濒死战损态_正面.png: 资产身份注册层 side 同源派生 source_sha256 与当前母本不一致；母本变更后必须重新裁切派生。
  - block [gate:image] 资产身份注册层 @ /Users/wesley/learn/anime-armory/创作区/制漫剧/那妖魔是姜大人/出图/共享/图片/定妆_CHAR_02__濒死战损态_正面.png: 资产身份注册层 back 同源派生 source_sha256 与当前母本不一致；母本变更后必须重新裁切派生。
- block · character:定妆_CHAR_03__诈死复苏态_正面.png · 资产身份注册层
  - block [gate:image] 资产身份注册层 @ /Users/wesley/learn/anime-armory/创作区/制漫剧/那妖魔是姜大人/出图/共享/图片/定妆_CHAR_03__诈死复苏态_正面.png: 资产身份注册层 three_quarter 同源派生 source_sha256 与当前母本不一致；母本变更后必须重新裁切派生。
  - block [gate:image] 资产身份注册层 @ /Users/wesley/learn/anime-armory/创作区/制漫剧/那妖魔是姜大人/出图/共享/图片/定妆_CHAR_03__诈死复苏态_正面.png: 资产身份注册层 side 同源派生 source_sha256 与当前母本不一致；母本变更后必须重新裁切派生。
  - block [gate:image] 资产身份注册层 @ /Users/wesley/learn/anime-armory/创作区/制漫剧/那妖魔是姜大人/出图/共享/图片/定妆_CHAR_03__诈死复苏态_正面.png: 资产身份注册层 back 同源派生 source_sha256 与当前母本不一致；母本变更后必须重新裁切派生。
- block · ops:candidate_selection_第2集.json · 关键镜候选
  - block [gate:image] 关键镜候选 @ /Users/wesley/learn/anime-armory/创作区/制漫剧/那妖魔是姜大人/生产数据/candidate_selection_第2集.json: 关键镜候选 production 出图后缺 candidate_selection_第2集.json；关键镜必须经过 best-of-N 选优而不是单张通过。生成候选后跑 `python3 skills/n2d-image/scripts/candidate_select.py "/Users/wesley/learn/anime-armory/创作区/制漫
- block · ops:score_第2集.json · 自动审片总分
  - block [score] 自动审片总分 @ 生产数据/score_第2集.json: 缺 score JSON；验收总账无法闭环
- block · ops:第2集 · 物料新鲜度 / 出图落档QC
  - warn [gate:image_prompt_preflight] 物料新鲜度 @ 第2集: 物料新鲜度 前期物料可能已过期：n2d, n2d-image, n2d-script 自上次 skill 基线后有改动，可能影响本阶段（image_prompt）的输入物料。出图/出视频是花钱且不可逆的步骤——先跑 `python3 skills/n2d-update/scripts/update_plan.py check "创作区/制漫剧/那妖魔是姜大人
  - block [gate:image] 出图落档QC @ /Users/wesley/learn/anime-armory/创作区/制漫剧/那妖魔是姜大人/生产数据/image_qc/第2集: 出图落档QC image gate 无法取得 image_qc findings：image_qc 报告声明的本集出图文件尚未落档：出图/第2集/图片/Clip04_end.png、出图/第2集/图片/Clip05_end.png、出图/第2集/图片/Clip05_first.png、出图/第2集/图片/Clip05_mid.png、出图/第2集/图片/Cl
