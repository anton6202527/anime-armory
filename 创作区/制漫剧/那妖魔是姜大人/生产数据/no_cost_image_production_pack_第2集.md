...
| REF_038 | P0 | EP02_CLIP01 | regional_construct_plate | 出图/第2集/区域构建/EP02_CLIP01/empty_plate.png |
| REF_039 | P0 | EP02_CLIP01 | region_masks | 出图/第2集/区域构建/EP02_CLIP01/masks.json |
| REF_040 | P0 | EP02_CLIP02 | regional_construct_plate | 出图/第2集/区域构建/EP02_CLIP02/empty_plate.png |
| REF_041 | P0 | EP02_CLIP02 | region_masks | 出图/第2集/区域构建/EP02_CLIP02/masks.json |
| REF_042 | P0 | EP02_CLIP03 | regional_construct_plate | 出图/第2集/区域构建/EP02_CLIP03/empty_plate.png |
| REF_043 | P0 | EP02_CLIP03 | region_masks | 出图/第2集/区域构建/EP02_CLIP03/masks.json |
| REF_044 | P0 | EP02_CLIP04 | regional_construct_plate | 出图/第2集/区域构建/EP02_CLIP04/empty_plate.png |
| REF_045 | P0 | EP02_CLIP04 | region_masks | 出图/第2集/区域构建/EP02_CLIP04/masks.json |
| REF_046 | P0 | EP02_CLIP05 | regional_construct_plate | 出图/第2集/区域构建/EP02_CLIP05/empty_plate.png |
| REF_047 | P0 | EP02_CLIP05 | region_masks | 出图/第2集/区域构建/EP02_CLIP05/masks.json |
| REF_048 | P0 | EP02_CLIP06 | regional_construct_plate | 出图/第2集/区域构建/EP02_CLIP06/empty_plate.png |
| REF_049 | P0 | EP02_CLIP06 | region_masks | 出图/第2集/区域构建/EP02_CLIP06/masks.json |
| REF_050 | P0 | EP02_CLIP07 | regional_construct_plate | 出图/第2集/区域构建/EP02_CLIP07/empty_plate.png |
| REF_051 | P0 | EP02_CLIP07 | region_masks | 出图/第2集/区域构建/EP02_CLIP07/masks.json |
| REF_052 | P0 | EP02_CLIP09 | regional_construct_plate | 出图/第2集/区域构建/EP02_CLIP09/empty_plate.png |
| REF_053 | P0 | EP02_CLIP09 | region_masks | 出图/第2集/区域构建/EP02_CLIP09/masks.json |

## 关键镜候选

| Clip | Tags | N | Status | Best |
|---|---|---:|---|---|
| EP02_CLIP01 | opening、hook_or_payoff、multi_subject、strong_emotion | 6 | needs_generation | - |
| EP02_CLIP02 | hook_or_payoff、multi_subject、strong_emotion | 5 | needs_generation | - |
| EP02_CLIP03 | multi_subject、strong_emotion、action | 5 | needs_generation | - |
| EP02_CLIP04 | signature_scene、hook_or_payoff、multi_subject、strong_emotion、action | 6 | needs_generation | - |
| EP02_CLIP05 | hook_or_payoff、multi_subject、strong_emotion | 5 | needs_generation | - |
| EP02_CLIP06 | hook_or_payoff、multi_subject、strong_emotion | 5 | needs_generation | - |
| EP02_CLIP07 | hook_or_payoff、multi_subject、strong_emotion | 5 | needs_generation | - |
| EP02_CLIP08 | hook_or_payoff、multi_subject、strong_emotion | 5 | needs_generation | - |
| EP02_CLIP09 | multi_subject、strong_emotion | 5 | needs_generation | - |
| EP02_CLIP10 | hook_or_payoff、multi_subject | 5 | needs_generation | - |
