...
- 复杂度: simple（2场景/3角色/2动作镜）· 预算 7.0/min · 片段经济档 紧凑· 超预算
...
- WARN generation_density_over_budget: 本集复杂度=simple（2场景/3角色/2动作镜），当前每分钟预计生成 9.46 次 > 预算 7.0/min。采纳下方 merge/单拍多镜合并后约 9.46/min。简单叙事优先「更少更长的多镜单拍」，不必逐节拍独立成付费 clip。
