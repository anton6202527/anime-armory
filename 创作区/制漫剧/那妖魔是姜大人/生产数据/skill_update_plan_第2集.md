...
- 需刷新 gate/QC：是（image）
- 变动 skill：n2d, n2d-batch, n2d-dashboard, n2d-image, n2d-review, n2d-script, n2d-update, n2d-voice
...
```bash
python3 skills/n2d-batch/scripts/queue.py plan "/Users/lalala/learn/anime-armory/创作区/制漫剧/那妖魔是姜大人" --episodes 2 --rerun-from script_stage1 --scope "skill 更新后重制到 image" --max-concurrency 1 --max-retries 1
```
