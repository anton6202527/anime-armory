...
## 行动项（人审后落进 prompt）
- [EP03_CLIP01] CHAR_01/镇魔司制服态：弱后端×核心长线角×大变化镜：建议升档——注册原生主体(Seedream/可灵/Sora)；仍压不住则 `python3 skills/n2d/n2d-lora/scripts/lora.py init <作品根> --character-id CHAR_01 --form '镇魔司制服态'`
...
- [EP03_CLIP02] CHAR_01/“囚途残损态”：弱后端×核心长线角×大变化镜：建议升档——注册原生主体(Seedream/可灵/Sora)；仍压不住则 `python3 skills/n2d/n2d-lora/scripts/lora.py init <作品根> --character-id CHAR_01 --form '“囚途残损态”'`
- [EP03_CLIP03] CHAR_01/“囚途残损态”：弱后端×核心长线角×大变化镜：建议升档——注册原生主体(Seedream/可灵/Sora)；仍压不住则 `python3 skills/n2d/n2d-lora/scripts/lora.py init <作品根> --character-id CHAR_01 --form '“囚途残损态”'`
- [EP03_CLIP04] CHAR_01/镇魔司制服态：弱后端×核心长线角×大变化镜：建议升档——注册原生主体(Seedream/可灵/Sora)；仍压不住则 `python3 skills/n2d/n2d-lora/scripts/lora.py init <作品根> --character-id CHAR_01 --form '镇魔司制服态'`
- [EP03_CLIP05] CHAR_01/镇魔司制服态：弱后端×核心长线角×大变化镜：建议升档——注册原生主体(Seedream/可灵/Sora)；仍压不住则 `python3 skills/n2d/n2d-lora/scripts/lora.py init <作品根> --character-id CHAR_01 --form '镇魔司制服态'`
...
- [EP03_CLIP06] CHAR_01/镇魔司制服态：弱后端×核心长线角×大变化镜：建议升档——注册原生主体(Seedream/可灵/Sora)；仍压不住则 `python3 skills/n2d/n2d-lora/scripts/lora.py init <作品根> --character-id CHAR_01 --form '镇魔司制服态'`
...
- [EP03_CLIP07] CHAR_01/镇魔司制服态：弱后端×核心长线角×大变化镜：建议升档——注册原生主体(Seedream/可灵/Sora)；仍压不住则 `python3 skills/n2d/n2d-lora/scripts/lora.py init <作品根> --character-id CHAR_01 --form '镇魔司制服态'`
...
- [EP03_CLIP08] CHAR_01/镇魔司制服态：弱后端×核心长线角×大变化镜：建议升档——注册原生主体(Seedream/可灵/Sora)；仍压不住则 `python3 skills/n2d/n2d-lora/scripts/lora.py init <作品根> --character-id CHAR_01 --form '镇魔司制服态'`
