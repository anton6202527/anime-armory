...
- anchor_fingerprint: `4f9937c0ec7753c3…`（锚点版本快照·5 form 已钉死；指纹变=锚点被改，跨集继承换脸风险）
...
| 姜月初 | 镇魔司伪装态 | ready | seedream:fallback_reference_group, kling:fallback_reference_group, sora:fallback_reference_group | kling:fallback_reference_group, seedance:fallback_reference_group, veo:fallback_reference_group, sora:fallback_reference_group | not_needed | - |
