...
| review_ui | block | review-ui 早于 score/ledger，界面与验收账本不新鲜。 |
| image_qc | pass | image_qc full 且新鲜。 |
| generation_recipe | block | missing or invalid /Users/wesley/learn/anime-armory/创作区/制漫剧/那妖魔是姜大人/生产数据/generation_recipe_manifest_第2集.json |
...
| release_evidence_freshness | block | 最终母版晚于部分发布证据；旧证据不能证明当前成片。 |
