...
| 中文 Prompt：虎山神胸口黑血妖气，黑褐妖血从胸口窟窿缓慢滴落，黑灰雾气贴着伤口回流，压迫但不过度血腥；可作为复苏态局部特效参考。（VFX_虎山神摹影） | 特效 | 🟡 medium | 34 | 禁漂项 5 个(+20)；结构/件数强锁(+8)；复用跨度(+6) |
| / 百妖谱（VFX_系统面板） | 特效 | 🟡 medium | 30 | 禁漂项 4 个(+16)；结构/件数强锁(+8)；复用跨度(+6) |
...
## 🟡 中文 Prompt：虎山神胸口黑血妖气，黑褐妖血从胸口窟窿缓慢滴落，黑灰雾气贴着伤口回流，压迫但不过度血腥；可作为复苏态局部特效参考。（VFX_虎山神摹影·特效）· 分 34
- 结构/件数强锁：参考图标清拓扑（单镜面/三件套/唯一圆口），逐镜 prompt 锁件数不增减。

## 🟡 / 百妖谱（VFX_系统面板·特效）· 分 30
- 结构/件数强锁：参考图标清拓扑（单镜面/三件套/唯一圆口），逐镜 prompt 锁件数不增减。
