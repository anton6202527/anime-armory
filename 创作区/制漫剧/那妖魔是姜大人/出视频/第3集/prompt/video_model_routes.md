...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| Clip_01 | CHAR_01/镇魔司制服态, CHAR_03/风尘劲装态, GROUP_01/齐跪态 | ensemble_blocking | seedance | dreamina | image2video | text_estimate_no_audio | base_video_then_post_lipsync | missing | high | native_multiframe | none | character_id_or_reference_group | required | motion_control_required | base_video_only, identity_drift_risk, multi_person, native_multiframe, post_lipsync_required | 先完成无台词基础视频；音色定妆与最终/可信导引音轨就绪后运行 lipsync_pass 独立驱动口型和表情。基础视频未经该 pass 不得作为最终说话镜进入 compose。 |
| Clip_02 | CHAR_01/“囚途残损态 | general_motion | seedance | dreamina | image2video | text_estimate_no_audio | base_video_then_post_lipsync | missing | fast | first_frame | none | reference_group | none | cross_episode_baseline | base_video_only, post_lipsync_required | 先完成无台词基础视频；音色定妆与最终/可信导引音轨就绪后运行 lipsync_pass 独立驱动口型和表情。基础视频未经该 pass 不得作为最终说话镜进入 compose。 |
| Clip_03 | CHAR_01/“囚途残损态, CHAR_01/镇魔司制服态 | dialogue_shot_reverse | seedance | dreamina | image2video | text_estimate_no_audio | post_dub | missing | high | native_multiframe | none | character_id_or_reference_group | none | cross_episode_baseline | mouth_visible, native_multiframe | Switch to over-shoulder, side-face, hands, or reaction inserts if mouth motion fails. |
...
| Clip_06 | CHAR_01/镇魔司制服态, CHAR_03/风尘劲装态, GROUP_01/列队戒备态 | dialogue_shot_reverse | seedance | dreamina | image2video | text_estimate_no_audio | base_video_then_post_lipsync | missing | high | native_multiframe | none | character_id_or_reference_group | none | frame_anchor_required | base_video_only, duration_segment_relay, mouth_visible, native_multiframe, post_lipsync_required | 先完成无台词基础视频；音色定妆与最终/可信导引音轨就绪后运行 lipsync_pass 独立驱动口型和表情。基础视频未经该 pass 不得作为最终说话镜进入 compose。 |
| Clip_07 | CHAR_01/镇魔司制服态, CHAR_03/风尘劲装态, GROUP_01/齐跪态 | ensemble_blocking | seedance | dreamina | image2video | text_estimate_no_audio | base_video_then_post_lipsync | missing | high | native_multiframe | none | character_id_or_reference_group | required | motion_control_required | base_video_only, identity_drift_risk, mouth_visible, multi_person, native_multiframe, post_lipsync_required | 先完成无台词基础视频；音色定妆与最终/可信导引音轨就绪后运行 lipsync_pass 独立驱动口型和表情。基础视频未经该 pass 不得作为最终说话镜进入 compose。 |
...
- characters: CHAR_01/“囚途残损态, CHAR_01/镇魔司制服态
- primary: seedance
- fallback: dreamina
- mode: image2video
