...
|---|---|---|---|---|---|
| 1 | EP01_CLIP01 | LOC_01/未来片段 | 3.884 | 冷开场·CU硬切 | 镜内尾锚（非接力） |
| 2 | EP01_CLIP02 | LOC_01/一炷香前 | 11.52 | dialogue_shot_reverse | 按 seam_mode 剪辑；无尾锚要求 |
| 3 | EP01_CLIP03 | LOC_01 | 11.989 | dialogue_shot_reverse | 按 seam_mode 剪辑；无尾锚要求 |
| 4 | EP01_CLIP04 | LOC_01 | 7.419 | dialogue_shot_reverse | 按 seam_mode 剪辑；无尾锚要求 |
| 5 | EP01_CLIP05 | LOC_01 | 11.608 | reveal_reaction_chain | 镜内尾锚（非接力） |
| 6 | EP01_CLIP06 | LOC_01 | 8.251 | fight_exchange | 镜内尾锚（非接力） |
| 7 | EP01_CLIP07 | LOC_01/主观系统层 | 10.811 | system_panel | 镜内尾锚（非接力） |
| 8 | EP01_CLIP08 | LOC_01 | 9.316 | fight_exchange | 镜内尾锚（非接力） |
