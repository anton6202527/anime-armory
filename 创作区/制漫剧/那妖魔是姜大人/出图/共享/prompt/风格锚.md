...
### 负向 prompt
风格禁忌：不要现代车辆/手机/水印、不要随机汉字或烤字、不要血腥猎奇断面、不要换脸换衣、不要把青面郎君画成俊美人类、不要高饱和页游仙侠光效；禁低幼Q版、禁欧美卡通脸、禁塑料3D、禁页游/仙侠游戏概念立绘、禁现代物件、禁高饱和霓虹、禁清晰人物脸、禁具体角色服装、禁剧情动作、禁文字/水印/logo。
### 检查清单
