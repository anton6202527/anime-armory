...
- root: /Users/lalala/learn/anime-arsenal/创作区/制漫剧/金睛缉妖录
- generated_at: 2026-06-30T17:32:21+00:00
- 告警数: 2（critical 1 / warn 1）

| 级别 | 类型 | 范围 | 说明 |
|---|---|---|---|
| 🔴 critical | qa_blockers | totals | QA 阻断 152 项（阈值 >0）；先按 recent_blockers 修复再继续付费生成 |
| 🟡 warn | qa_blockers | 第1集 | 第1集 QA 阻断 152 项 |
