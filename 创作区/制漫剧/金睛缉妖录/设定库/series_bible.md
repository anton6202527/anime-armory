...
| 集 | Clips | 角色 | 资产 | 钩子 | 线程 |
|---|---:|---|---|---|---|
| 第1集 | 12 | CHAR_PI_DEMON_CHENGUI、CHAR_SHEN_YAN、CHAR_FANGZHENG、CHAR_CHEN_WIFE、FAMILY_CHEN、CHAR_PEIJUE | PROP_STILL_TEA、PROP_BLOOD_THRESHOLD、LOC_CHEN_HOUSE、PROP_MUD_FOOTPRINT、PROP_CLEAN_BLACK_BOOT、PROP_OLD_COPPER_HALF、VFX_JINJING_GOLD_EYE、VFX_SKIN_DEMON_REVEAL、VFX_PEIJUE_FU_FIRE | 6 | 8 |
| 第2集 | 0 | - | - | 0 | 1 |
| 第3集 | 0 | - | - | 0 | 1 |
| 第4集 | 0 | - | - | 1 | 0 |
| 第5集 | 0 | - | - | 2 | 1 |
