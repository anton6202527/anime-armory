...
| 第3集 | 13 | CHAR_HE_PINGSHENG、CHAR_ZHANG_LAODA、CHAR_INNER_SECT | PROP_BLACK_BASIN、PROP_GOLD_RICE、LOC_SERVANT_HUT、PROP_GREY_RICE_MEMORY、PROP_DOOR_LOCK、PROP_DOOR、PROP_GOLD_RICE_visible、PROP_TROUSER_PILLOW、PROP_MOUNTAIN_SPRING、PROP_WATER_BUCKETS、LOC_MOUNTAIN_SPRING、PROP_WATER_JAR、LOC_KITCHEN_YARD、PROP_INNER_SECT_LANTERN、LOC_INNER_SECT_DISTANCE | 6 | 8 |
| 第4集 | 0 | - | - | 0 | 0 |
| 第5集 | 0 | - | - | 2 | 1 |
| 第6集 | 0 | - | - | 0 | 0 |
| 第7集 | 0 | - | - | 0 | 1 |
