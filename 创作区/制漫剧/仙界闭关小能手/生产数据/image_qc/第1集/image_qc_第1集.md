...
- episode: 第1集
- 总判定: **block** · 硬阻断 7（必须修） · 非阻断初筛 8 · 视觉降级 0
...
## 角色脸定妆比对覆盖（硬闸）
- 🔴 已落档角色图 required 6 · covered 5 · missing 1 · pending 16 · precision full
  - 🔴 镜头 1（`EP01_CLIP01` · 黑殿围审与费钱货羞辱 · dialogue_shot_reverse） 图片/Clip_01_a2.png：face_verdict_warn
...
- 确认文件: `/Users/wesley/learn/anime-armory/创作区/制漫剧/仙界闭关小能手/生产数据/image_qc/第1集/prop_shape_confirmations.json`
  ...
  - 🔴 Clip_01 图片/Clip_01_a2.png（PROP_CARRYING_POLE 木扁担） 禁形=现代物件、文字水印、结构漂移、数量漂移；尺寸=None；/Users/wesley/learn/anime-armory/创作区/制漫剧/仙界闭关小能手/生产数据/image_qc/第1集/prop_shape_review/PROP_CARRYING_POLE_Clip_01_Clip_01_a2_compare.png
  ...
  - 🔴 Clip_01 图片/Clip_01_a2.png（PROP_SERVANT_HALL_LAMP 黑殿旧油灯） 禁形=现代物件、文字水印、结构漂移、数量漂移、现代电灯、霓虹、清晰文字、华丽仙器；尺寸=None；/Users/wesley/learn/anime-armory/创作区/制漫剧/仙界闭关小能手/生产数据/image_qc/第1集/prop_shape_review/PROP_SERVANT_HALL_LAMP_Clip_01_Clip_01_a2_compare.png
  ...
  - 🔴 Clip_01 图片/Clip_01_a2.png（PROP_WATER_JAR_PAIR 两口水缸） 禁形=现代物件、文字水印、结构漂移、数量漂移；尺寸=None；/Users/wesley/learn/anime-armory/创作区/制漫剧/仙界闭关小能手/生产数据/image_qc/第1集/prop_shape_review/PROP_WATER_JAR_PAIR_Clip_01_Clip_01_a2_compare.png
