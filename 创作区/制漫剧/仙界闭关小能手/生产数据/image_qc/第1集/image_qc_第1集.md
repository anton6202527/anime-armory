...
- episode: 第1集
- 总判定: **review** · 硬阻断 0（必须修） · 非阻断初筛 5 · 视觉降级 0
...
## 高风险道具禁形/尺寸逐图复核（硬闸）
- total 3 · pending 0 · confirmed 3
- 确认文件: `/Users/wesley/learn/anime-armory/创作区/制漫剧/仙界闭关小能手/生产数据/image_qc/第1集/prop_shape_confirmations.json`
  - 🟢 Clip_01 图片/Clip01_first.png（PROP_CARRYING_POLE 木扁担） 禁形=现代物件、文字水印、结构漂移、数量漂移；尺寸=None；/Users/wesley/learn/anime-armory/创作区/制漫剧/仙界闭关小能手/生产数据/image_qc/第1集/prop_shape_review/PROP_CARRYING_POLE_Clip_01_Clip01_first_compare.png
  - 🟢 Clip_01 图片/Clip01_first.png（PROP_SERVANT_HALL_LAMP 黑殿旧油灯） 禁形=现代物件、文字水印、结构漂移、数量漂移、现代电灯、霓虹、清晰文字、华丽仙器；尺寸=None；/Users/wesley/learn/anime-armory/创作区/制漫剧/仙界闭关小能手/生产数据/image_qc/第1集/prop_shape_review/PROP_SERVANT_HALL_LAMP_Clip_01_Clip01_first_compare.png
  - 🟢 Clip_01 图片/Clip01_first.png（PROP_WATER_JAR_PAIR 两口水缸） 禁形=现代物件、文字水印、结构漂移、数量漂移；尺寸=None；/Users/wesley/learn/anime-armory/创作区/制漫剧/仙界闭关小能手/生产数据/image_qc/第1集/prop_shape_review/PROP_WATER_JAR_PAIR_Clip_01_Clip01_first_compare.png
