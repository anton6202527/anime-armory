...
- episode: 第2集
- 总判定: **block** · 硬阻断 34（必须修） · 非阻断初筛 83 · 视觉降级 0
...
## 角色脸定妆比对覆盖（硬闸）
- 🟢 已落档角色图 required 32 · covered 32 · missing 0 · pending 8 · precision full

## 跨集脸漂移趋势（B·治每集过floor但逐集偏离·advisory）
- 🟡 张老大：第1集→第2集 均值 0.7847→0.6941（掉幅 0.0906）
...
## 高风险道具禁形/尺寸逐图复核（硬闸）
- total 34 · pending 34 · confirmed 0
