...
| 角色 | 风险 | 分 | 锁脸档 | 主驱动 |
|---|---|---|---|---|
| 张老大（CHAR_02/常态） | 🔴 high | 78.0 | multi_reference | 近景占比 3/3(+30.0)；锁脸档位=multi_reference(+22)；多人同框 3/3(+20.0) |
| 贺平生（CHAR_01/本集为14岁杂役常态） | 🔴 high | 62.3 | multi_reference | 近景占比 6/7(+25.7)；锁脸档位=multi_reference(+22)；极端角度 2 镜(+12) |

## 🔴 张老大（CHAR_02/常态）· 分 78.0
