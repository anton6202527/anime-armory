...
- 生成时间：2026-07-17T01:22:11+00:00
...
|---:|---:|---|---:|---:|---:|---:|---:|---:|---:|
| 2 | 136 | — | 4h20m50s | 67 | 0 | 1 | 36 | 83.6% | 0.0% |

## ROI

| 成片分钟 | 每分钟成本 | 每集耗时 | 一次通过率 | 重抽率 | 投放播放 | 投放收入 | 投放成本 | 净回收 | 回收/生产成本 |
|---:|---|---:|---:|---:|---:|---|---|---|---:|
| 50s | — | 4h20m50s | 67.2% | 0.0% | 0 | — | — | — | — |
...
|---|---|---|---|---:|---:|---:|---|---:|---|---:|---:|---:|---:|---:|
| 第1集 | 出图 | — | — | 4h20m50s | 67.2% | 0.0% | — | 1 | — | — | — | — | — | — |
| 全剧 | — | — | — | 0s | — | — | — | 0 | — | — | — | — | — | — |

## 最新阻断

- 第1集 / image / 出图落档QC: /Users/lalala/learn/anime-armory/创作区/制漫剧/仙界闭关小能手/生产数据/image_qc/第1集/image_qc_第1集.json — 发现未入账 image_qc 报告但其新鲜度为 `stale`：报告 `inputs_fingerprint` 与当前文件失配：出图/第1集/prompt/01_分镜出图.md(变更)。先重跑 `dashboard gate --stage image` 或 image_qc，不能用旧报告证明图片一致。
