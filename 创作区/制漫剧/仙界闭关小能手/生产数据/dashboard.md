...
- 生成时间：2026-07-03T10:05:36+00:00
...
|---:|---:|---|---:|---:|---:|---:|---:|---:|---:|
| 10 | 1775 | credits 6268.00 | 18h44m34s | 366 | 42 | 292 | 997 | 98.4% | 0.0% |

## ROI

| 成片分钟 | 每分钟成本 | 每集耗时 | 一次通过率 | 重抽率 | 投放播放 | 投放收入 | 投放成本 | 净回收 | 回收/生产成本 |
|---:|---|---:|---:|---:|---:|---|---|---|---:|
| 4m29s | credits 1396.85/min | 18h44m34s | 86.1% | 11.5% | 0 | — | — | — | — |
...
| 第2集 | 出图 | — | — | 4h34m46s | 57.8% | 42.2% | 002-image-rerun Codex image_generation 真实重出 Clip_16_end，禁止本地贴脸修复×2；002-image-rerun Codex image_generation 真实重出 Clip_01，禁止本地贴脸修复×1；002-image-rerun Codex image_generation 真实重出 Clip_01_end，禁止本地贴脸修复×1 | 37 | — | — | — | — | — | — |
| 第3集 | 阶段1·剧本改编 | — | — | 0s | — | — | — | 0 | — | — | — | — | — | — |
| 第4集 | 阶段1·剧本改编 | — | — | 0s | — | — | — | 0 | — | — | — | — | — | — |
| 第5集 | 阶段1·剧本改编 | — | — | 0s | — | — | — | 0 | — | — | — | — | — | — |
| 第6集 | 阶段1·剧本改编 | — | — | 0s | — | — | — | 0 | — | — | — | — | — | — |
...
| 维度 | 次数 | 占比 |
|---|---:|---:|
| 脸漂/身份 (face_consistency) | 38 | 90% |
| 画风 (style_drift) | 4 | 10% |
| **一致性小计**（脸漂/服装/场景/画风） | **42** | **100%** |
