...
- 生成时间：2026-07-07T12:24:35+00:00
...
|---:|---:|---|---:|---:|---:|---:|---:|---:|---:|
| 10 | 72 | — | 2h00m25s | 44 | 0 | 3 | 12 | 97.7% | 0.0% |

## ROI

| 成片分钟 | 每分钟成本 | 每集耗时 | 一次通过率 | 重抽率 | 投放播放 | 投放收入 | 投放成本 | 净回收 | 回收/生产成本 |
|---:|---|---:|---:|---:|---:|---|---|---|---:|
| 1m18s | — | 2h00m25s | 97.7% | 0.0% | 0 | — | — | — | — |
...
- 第1集 / image / 出图落档QC: /Users/wesley/learn/anime-armory/创作区/制漫剧/仙界闭关小能手/生产数据/image_qc/第1集/image_qc_第1集.json — image_qc standalone 报告有 3 个硬阻断但未见 dashboard image gate 入账；必须修复/重抽并重跑 `dashboard gate --stage image`。
