...
- 生成时间：2026-07-15T17:53:20+00:00
...
|---:|---:|---|---:|---:|---:|---:|---:|---:|---:|
| 2 | 112 | — | 2h06m01s | 48 | 0 | 7 | 44 | 93.8% | 0.0% |

## ROI

| 成片分钟 | 每分钟成本 | 每集耗时 | 一次通过率 | 重抽率 | 投放播放 | 投放收入 | 投放成本 | 净回收 | 回收/生产成本 |
|---:|---|---:|---:|---:|---:|---|---|---|---:|
| 50s | — | 2h06m01s | 79.2% | 0.0% | 0 | — | — | — | — |
...
|---|---|---|---|---:|---:|---:|---|---:|---|---:|---:|---:|---:|---:|
| 第1集 | 出图prompt | — | — | 2h06m01s | 79.2% | 0.0% | — | 7 | — | — | — | — | — | — |
| 全剧 | — | — | — | 0s | — | — | — | 0 | — | — | — | — | — | — |
...
- 第1集 / image / 出图落档QC: /Users/lalala/learn/anime-armory/创作区/制漫剧/仙界闭关小能手/生产数据/image_qc/第1集/image_qc_第1集.json — image_qc standalone 报告有 6 个硬阻断但未见 dashboard image gate 入账；必须修复/重抽并重跑 `dashboard gate --stage image`。
