...
- 生成时间：2026-07-03T08:23:52+00:00
...
|---:|---:|---|---:|---:|---:|---:|---:|---:|---:|
| 10 | 1808 | credits 6268.00 | 17h25m03s | 348 | 24 | 361 | 1000 | 98.3% | 0.0% |

## ROI

| 成片分钟 | 每分钟成本 | 每集耗时 | 一次通过率 | 重抽率 | 投放播放 | 投放收入 | 投放成本 | 净回收 | 回收/生产成本 |
|---:|---|---:|---:|---:|---:|---|---|---|---:|
| 4m29s | credits 1396.85/min | 17h25m03s | 90.5% | 6.9% | 0 | — | — | — | — |
...
| 第2集 | 出图 | — | — | 3h15m16s | 72.2% | 27.8% | 002-image-rerun Codex image_generation 真实重出 Clip_01，禁止本地贴脸修复×1；002-image-rerun Codex image_generation 真实重出 Clip_01_end，禁止本地贴脸修复×1；002-image-rerun Codex image_generation 真实重出 Clip_02，禁止本地贴脸修复×1 | 106 | — | — | — | — | — | — |
| 第3集 | 阶段1·剧本改编 | — | — | 0s | — | — | — | 0 | — | — | — | — | — | — |
| 第4集 | 阶段1·剧本改编 | — | — | 0s | — | — | — | 0 | — | — | — | — | — | — |
| 第5集 | 阶段1·剧本改编 | — | — | 0s | — | — | — | 0 | — | — | — | — | — | — |
| 第6集 | 阶段1·剧本改编 | — | — | 0s | — | — | — | 0 | — | — | — | — | — | — |
...
| 维度 | 次数 | 占比 |
|---|---:|---:|
| 脸漂/身份 (face_consistency) | 20 | 83% |
| 画风 (style_drift) | 4 | 17% |
| **一致性小计**（脸漂/服装/场景/画风） | **24** | **100%** |
