...
- 「张老大」第2集：say:Tingting_placeholder（4 句）
  - 回流：return_to_stage=voice；第2集 角色「张老大」为占位应急轨（say:Tingting_placeholder），需用注册音色重配（n2d-voice）后再出图/合成
- 「旁白」第2集：say:Tingting_placeholder（13 句）
