...
function HubBrandIcon() {
  return (
    <svg className="labutv-mark" viewBox="0 0 48 48" aria-hidden="true">
      <defs><linearGradient id="desktop-labutv-gradient" x1="7" y1="5" x2="42" y2="44" gradientUnits="userSpaceOnUse"><stop stopColor="#9b8cff" /><stop offset=".52" stopColor="#736dff" /><stop offset="1" stopColor="#536df6" /></linearGradient></defs>
