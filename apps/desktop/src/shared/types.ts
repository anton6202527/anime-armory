...
// Public cloud configuration may be bundled into the desktop client. Access
// tokens and provider credentials never cross into renderer code.
...
export type CloudSyncPhase = "scanning" | "hashing" | "uploading" | "downloading" | "finalizing";
