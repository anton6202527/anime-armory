...
export function registerIpc(s: MainServices) {
  const handlers: HandlerMap = {
    ...
    'canvas.read': (a) => canvas.readCanvas(a.root, a.ep, a.knownSig, a.line),
    ...
    'canvas.writeClipEdit': (a) => canvas.writeClipEdit(
      a.root,
      a.ep,
      a.clipId,
      a.number,
      a.patch,
      a.line,
      a.expectedContentHash,
    ),
    'canvas.readGenerationConfig': (a) => canvas.readCanvasGenerationConfig(
      a.root, a.ep, a.clipId, a.kind, a.targetSlot, a.targetOutputPath,
    ),
    'canvas.submitGeneration': (a) => canvas.submitCanvasGenerationTask(
      a.root,
      a.ep,
      a.line,
      a.clipId,
    ...
    'canvas.commitGeneration': (a) => canvas.commitCanvasGenerationTask(
      a.root,
      a.ep,
      a.line,
      a.clipId,
    ...
    'canvas.startProduction': (a) => canvas.startCanvasProduction(
      a.root,
      a.ep,
      a.line,
      a.expectedContentHash,
    ),
    'canvas.acceptFinal': (a) => canvas.acceptCanvasProductionFinal(
      a.root,
      a.ep,
      a.line,
      a.expectedContentHash,
    ),
    'canvas.failTask': (a) => canvas.failCanvasProductionTask(a.root, a.ep, a.jobId, a.detail),
    'canvas.markTaskRunning': (a) => canvas.markCanvasProductionTaskRunning(a.root, a.ep, a.jobId),
