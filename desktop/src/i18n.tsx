...
const zh = {
  ...
  "operation.n2dBootstrapPrompt": "请读取当前作品目录中的小说源文件（txt / md / docx / pdf），初始化 n2d 项目并开始制作漫剧。作品目录：{path}。完成后按项目约定回写 _进度.md，并刷新必要产物。",
...
const en: Record<I18nKey, string> = {
  ...
  "operation.n2dBootstrapPrompt": "Read the novel source file in this work directory (txt / md / docx / pdf), initialize the n2d project, and start making the comic drama. Work directory: {path}. After finishing, update _进度.md and refresh required outputs.",
