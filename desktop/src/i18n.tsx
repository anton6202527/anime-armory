...
const zh = {
  ...
  "line.downloadDemo": "下载完整示例",
  "line.downloadDemoTitle": "后台下载完整示例",
  "line.downloadDemoFailed": "下载完整示例失败：{error}",
  "line.downloadResolving": "准备下载…",
  "line.downloadingDemo": "下载中",
  "line.downloadExtracting": "解压中",
  ...
  "files.importNovelHint": "可选择或拖入 txt / md / docx；PDF 可先导入为源文件。",
...
const en: Record<I18nKey, string> = {
  ...
  "line.downloadDemo": "Download Full Sample",
  "line.downloadDemoTitle": "Download the full sample in the background",
  "line.downloadDemoFailed": "Could not download the sample: {error}",
  "line.downloadResolving": "Preparing download…",
  "line.downloadingDemo": "Downloading",
  "line.downloadExtracting": "Extracting",
  ...
  "files.importNovelHint": "Choose or drop txt / md / docx files; PDFs can be imported as source files.",
