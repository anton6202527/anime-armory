...
const zh = {
  ...
  "search.inputPlaceholder": "搜索文件",
  "search.placeholder": "输入关键词搜索文件名和文本内容。",
  "search.options": "搜索选项",
  "search.includeContent": "搜索文件内容",
  "search.content": "内容",
...
const en: Record<I18nKey, string> = {
  ...
  "search.searchPlaceholder": "Search",
  "search.replacePlaceholder": "Replace",
  "search.inputPlaceholder": "Search files",
  "search.placeholder": "Type to search file names and text content.",
  "search.options": "Search options",
  "search.includeContent": "Search file contents",
