...
const zh = {
  ...
  "operation.emptyN2dHeadline": "要去小说区看看有哪些小说可以制漫剧了吗",
  "operation.emptyN2dPrompt": "要去小说区看看有哪些小说可以制漫剧了吗？请检查当前工作区的写小说（novel）项目，列出可改编成制漫剧的候选小说、路径、当前进度、适合改编的理由，并建议下一步选择哪个进入 n2d。当前制漫剧项目目录为空：{path}",
...
const en: Record<I18nKey, string> = {
  ...
  "operation.emptyN2dHeadline": "Check the novel area for stories that can be adapted?",
  "operation.emptyN2dPrompt": "Check the novel area for stories that can be adapted into an n2d comic-drama. Inspect the current workspace's novel projects, list candidate novels with paths, progress, adaptation fit, and recommend which one should enter n2d next. The current n2d project directory is empty: {path}",
